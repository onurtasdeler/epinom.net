...
<head>
    ...
    <link href="<?= getTableSingle("options_general",array("id" => 1) )->site_admin_link ?>/assets/plugins.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?= getTableSingle("options_general",array("id" => 1) )->site_admin_link ?>/assets/style.bundle.css" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <a href="#" class="d-block d-lg-none mx-auto py-20">
            ...
            ?>
            <img alt="Logo" src="<?= $cekLogo->site_link ?>/upload/logo/<?= $cekLogo->site_logo ?>" class=" h-25px" />
        ...
        <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
            ...
            <div class="d-flex  align-items-center  mw-450px w-100">
                ...
                <div class="py-20 w-100" style="width: 100% !important;">
                    <img alt="Logo" src="<?= $cekLogo->site_link ?>/upload/logo/<?= $cekLogo->site_logo ?>" class=" h-50px" />
                    <!--begin::Form-->
                    <form class="form w-100" method="post" id="login-form" onsubmit="return false">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-start mb-10">
                                <!--begin::Title-->
                                <!--end::Title-->
                                <h3 class="tt text-white">Bayi Paneli</h3>
                                <h4 class="text-white">Hoşgeldiniz <?= $users->full_name ?></h4>
                                <p class="text-white">Lütfen Dikkat! <br>
                                    Bu panel size özel oluşturulmuş bir paneldir. <br> Lütfen giriş bilgilerinizi ve link bilgisini 3.kişiler ile paylaşmayınız. Aksi takdirde  oluşacak problemler sizlerin sorumluluğundadır.</p>
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <input class="form-control form-control-solid" placeholder="Email Adresiniz" type="text" name="email" autocomplete="off" autocomplete="off" />
                            ...
                            <div class="fv-row mb-7">
                                <input type="hidden" name="token" value="<?= $users->bayi_token ?>">
                                <!--begin::Password-->
        ...
        <div class="d-none d-lg-flex align-items-center justify-content-center flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background:#1b1b29">
            <div class="row w-50">
                <div class="col-lg-12">
                    <img alt="Logo" src="<?= $cekLogo->site_link ?>/upload/logo/<?= $cekLogo->site_logo ?>" class="     " />
                </div>
            </div>
        </div>
        <!--begin::Body-->
