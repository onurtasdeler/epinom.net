        ...
        <polygon fill="#000000" opacity="0.3"
                 ...
                 points="5.55025253 13.9497475 5.55025253 19.6640332 7.05025253 21.9497475 8.55025253 19.6640332 8.55025253 13.9497475"/>
                                            ...
                                            if ($data["veri"]->status == 1) {
                                                ...
                                                $class = "success";
                                                $icon = "fa fa-check";
                                                $text = "Tamamlandı - " . $data["veri"]->update_at;
                                    ...
                                    <div class="card-body pt-4">
                                        ...
                                        <?php
                                        if($data["veri"]->status==5 || $data["veri"]->status==3 || $data["veri"]->status==1  ){
                                            ?>
                                            ...
                                            ?>
                                            <p><span class="text-info"> Sipariş Bilgi :</span> <?= $data["veri"]->siparis_bilgi ?></p>
                                            <p><span class="text-warning"> SMS Bilgi:</span> <?= $data["veri"]->siparis_sms_bilgi ?></p>
                                            <p><span class="text-warning"> Email Bilgi:</span> <?= $data["veri"]->siparis_email_bilgi ?></p>
                                            <?php
                                        }
                                    ...
                                    <div class="card-body pt-4">
                                        <div class="table-responsive">
                                            ...
                                            if($data["veri"]->special_field!=""){
                                                $cek=getTableSingle("table_products_special",array("p_id" => $urun->id,"is_main" => 1,"status" => 1));
                                                if($cek){
                                                    ?>
                                                    <table class="table">
                                                        <thead>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Komisyon Tutarı (<?= getcur() ?>)</th>
                                                    <th>Net Kazanç</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                                    <td><?= $data["veri"]->komisyon_bayi ?></td>
                                                  
                                                    <td><?= $data["veri"]->komisyon_bayi_tutar ?> <?= getcur() ?></td>
                                                    <td><?= $data["veri"]->bayi_net_kazanc ?> <?= getcur() ?></td>
