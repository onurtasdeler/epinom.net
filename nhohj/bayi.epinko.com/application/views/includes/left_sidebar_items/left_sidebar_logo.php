 ...
 */
?>
<div class="brand flex-column-auto justify-content-center" id="kt_brand" style="background-color: #000000">
    <!--begin::Logo-->
            ...
            if ($this->uri->segment(2)) {
                if ($this->uri->segment(3)) {
                    ...
                    <img class="img-fluid" alt="Logo"
                         src="<?= $ayarlarr->site_link."/" ?>upload/logo/<?= $ayarlarr->site_logo ?>"
