                                                        ...
                                                        <div class="image-input image-input-outline" id="kt_image_2">
                                                            ...
                                                            if ($data["veri"]->image != "") {
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                     style="background-size:contain;background-image: url(<?= getTableSingle("options_general",array("id" => 1))->site_link."/upload/product/" ?><?= $data['veri']->image ?>)"></div>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <div class="image-input-wrapper"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <select name="kategori_id"
                                                            ...
                                                            <?php
                                                            $cats=getTableOrder("table_products_category",array(),"c_name","asc");
                                                            if($cats){
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12" style="display:none">
                                                        <div class="form-group">
                                                            <label>Kar Marjı <b>%<?= $data["veri"]->price_marj ?></b></label>
                                                            <input type="hidden"
                                                                   step="0.01"
                                                                   class="form-control"
                                                                   id="kar_marj"
                                                                   name="kar_marj"
                                                                   placeholder="Kar Marjı (%)" min="0" value="0" max="100"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <?php
                                                        ...
                                                        <p style="line-height:30px;"><b style="">Komisyon Oranı (%) : </b> <span id="satisText" class="text-danger font-weight-bold"> %<?= $data["veri"]->bayi_kom ?></span></p>
                                                                <?php

                                                                if($data["veri"]->is_discount==1){

                                                                    ?>
                                                                    <p style="line-height:30px;"><b style="">Komisyon Tutarı (₺) : </b> <span id="komisyontutar" class="text-danger font-weight-bold"><?= number_format((($data["veri"]->price_sell_discount * $data["veri"]->bayi_kom)/100),2) ?> ₺</span></p>
                                                                    <p style="line-height:30px;"><b style="">Net Kazanç (₺) : </b> <span id="netkazanc" class="text-danger font-weight-bold"><?= number_format($data["veri"]->price_sell_discount-(($data["veri"]->price_sell_discount * $data["veri"]->bayi_kom)/100),2) ?> ₺</span></p>
                                                                <?php
                                                        }else{
                                                                    $hesaplass=($data["veri"]->bayi_kom * $data["veri"]->price_sell) / 100;

                                                                    ?>
                                                                    <p style="line-height:30px;"><b style="">Komisyon Tutarı (₺) : </b> <span id="komisyontutar" class="text-danger font-weight-bold"><?= number_format((($data["veri"]->price_sell * $data["veri"]->bayi_kom)/100),2) ?> ₺</span></p>
                                                                    <p style="line-height:30px;"><b style="">Net Kazanç (₺) : </b> <span id="netkazanc" class="text-danger font-weight-bold"><?= number_format($data["veri"]->price_sell-(($data["veri"]->price_sell * $data["veri"]->bayi_kom)/100),2) ?> ₺</span></p>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </span></p>
