                                            ...
                                            <div class="row">
                                                <div class="col-xl-3">
                                                    <div class="form-group" style="text-align: center">
                                                        <div>
                                                            <label>Liste Resim <br> (1280 x 1360)</label>
                                                        </div>
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <select name="turkpin_kategori_id" class="form-control turkpinkategori">
                                                            ...
                                                            foreach($oyunlar as  $row)
                                                            {
                                                                ...
                                                                ?>
                                                                <option value="0">
                                                                    Türkpin ile bağlantı sağlananamdı.
                                                                </option>
                                                                <?php
                                                            }
                                                            ?>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" checked="checked" name="is_tc">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" checked="checked" name="is_anasayfa">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" checked="checked" name="is_slider">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" checked="checked" name="is_populer">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" checked="checked" name="is_new">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
