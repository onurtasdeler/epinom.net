<form id="guncelleForm" onsubmit="return false" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3">
                                                ...
                                                <div class="form-group" style="text-align: center">
                                                    <div>
                                                        <label>Liste Resim <br> (1280px x 1360px)</label>
                                                    </div>
                                            ...
                                            <div class="col-xl-3">
                                                <div class="form-group" style="text-align: center">
                                                    <div>
                                                        <label>Banner Sağ (200x700px)</label>
                                                    </div>
                                                    <div class="image-input image-input-outline" id="kt_image_5">
                                                        ...
                                                        if ($data["veri"]->image_banner_sag != "") {
                                                            ?>
                                                            <div class="image-input-wrapper"
                                                                 style="background-color:black;background-size:contain;background-image: url(../../upload/category/<?= $data['veri']->image_banner_sag ?>)"></div>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <div class="image-input-wrapper"
                                            ...
                                            <div class="col-xl-3">
                                                <div class="form-group" style="text-align: center">
                                                    <div>
                                                        <label>Banner Sol (200x700px)</label>
                                                    </div>
                                                    <div class="image-input image-input-outline" id="kt_image_6">
                                                        ...
                                                        if ($data["veri"]->image_banner_sol != "") {
                                                            ?>
                                                            <div class="image-input-wrapper"
                                                                 style="background-color:black;background-size:contain;background-image: url(../../upload/category/<?= $data['veri']->image_banner_sol ?>)"></div>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <div class="image-input-wrapper"
                                                        ...
                                                        if ($data["veri"]->image_banner_sol != "") {
                                                            ...
                                                            <span style="display: block"
                                                                  class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                                                  data-action="cancel" title="Vazgeç/Sil">
                                                <a href="#" onclick="deleteModal(<?= $data["veri"]->id ?>,6)"
                                                   data-toggle="modal" data-id="' + row.ssid + '" data-target="#menu"><i
                                                            class="ki ki-bold-close icon-xs text-muted"></i></a>
                                            </span>
                                                            <?php
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-xl-3">
                                                        ...
                                                        <input type="text"
                                                               class="form-control"
                                                                id="name" name="name"
                                                               placeholder="Kategori Adı" value="<?= $data["veri"]->c_name ?>"/>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label><b>Kategori Grubu</b></label>
                                                        <select name="grup_id" class="form-control" required>
                                                            <option value="">Seçiniz</option>
                                                            <option <?= ($data["veri"]->category_grup=="Epin")?"selected":""  ?> value="Epin">Epin</option>
                                                            <option <?= ($data["veri"]->category_grup=="Sosyal Medya")?"selected":""  ?> value="Sosyal Medya">Sosyal Medya</option>
                                                            <option <?= ($data["veri"]->category_grup=="Yazılım")?"selected":""  ?> value="Yazılım">Yazılım</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xl-3">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M0.00065168429,20.1992055 C0.388258525,15.4265159 4.26191235,13 8.98334134,13 C13.7712164,13 17.7048837,15.2931929 17.9979143,20.2 C18.0095879,20.3954741 17.9979143,21 17.2466999,21 C13.541124,21 8.03472472,21 0.727502227,21 C0.476712155,21 -0.0204617505,20.45918 0.00065168429,20.1992055 Z" fill="#000000" fill-rule="nonzero"/>
                        ...
                        <a href="<?= base_url("urunler?c=".$data["veri"]->id) ?>" class="btn btn-block btn-success mr-2 mt-5">Ürünleri Gör</a>
                    </div>
                </div>
