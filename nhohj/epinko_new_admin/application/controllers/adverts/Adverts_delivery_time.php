...
class Adverts_delivery_time extends CI_Controller
{
    public $formControl = "";
    public $imgId = "";
    public $settings = "";
    public $viewFolder="adverts/adverts_delivery_time";
    public $viewFile="blank";
    public $tables="table_adverts_delivery_time";
    public $baseLink="ilan-teslimat-sureleri";
    ...
    public function index()
    {
        ...
        $page = array(
            "pageTitle" => "İlan Teslimat Süreleri - " . $this->settings->site_name,
            "subHeader" => "İlan Yönetimi - <a href='" . base_url("ilan-teslimat-sureleri") . "'>İlan Teslimat Süreleri</a>",
            "h3" => "İlan Teslimat Süreleri",
            "btnText" => "Yeni İlan Teslimat Süresi Ekle", "btnLink" => base_url("ilan-teslimat-sureleri-ekle"));
    ...
    public function actions_add()
    {
        ...
        $page = array(
            "pageTitle" => "İlan Teslimat Süresi Ekle - " . $this->settings->site_name,
            "subHeader" => "İlan Yönetimi - <a href='" . base_url("ilan-teslimat-sureleri") . "'>İlan Teslimat Süreleri</a> - İlan Teslimat Süresi Ekle",
            "h3" => "İlan Teslimat Süreleri",
        ...
        if ($_POST) {
            if ($this->formControl == $this->session->userdata("formCheck")) {
                if ($veri["err"] != true) {
                    ...
                    if($kaydet){
                        redirect(base_url("ilan-teslimat-sureleri?type=1"));
                    }else{
    ...
    public function actions_update($id)
    {
        ...
        if ($kontrol) {
            ...
            $page = array(
                "pageTitle" => "İlan Teslimat Sürelesi Güncelle - " . $this->settings->site_name,
                "subHeader" => "İlan Yönetimi - <a href='" . base_url("ilan-teslimat-sureleri") . "'>İlan Teslimat Süreleri</a> - İlan Teslimat Süresi Güncelle",
                "h3" => "İlan Teslimat Süresi Güncelle",
