...
class Coupon extends CI_Controller
{
    ...
    public $imgId = "";
    public $settings = "";
    public $viewFolder="coupon/items";
    ...
    public function index()
    {
        ...
        $page = array(
            "pageTitle" => "İndirim Kuponu Yönetimi - " . $this->settings->site_name,
            "subHeader" => "İndirim Kuponu Yönetimi - <a href='" . base_url("coupon") . "'>Kuponlar</a>",
            "h3" => "İndirim Kuponları",
            "btnText" => "", "btnLink" => base_url("kupon-ekle"));
            ...
            if($this->input->post("updateId")){
                ...
                if($code && $sayi && $tutar){
                    ...
                    if($kont){
                        ...
                        if($ekle){
                            $hatayok="Kupon Başarılı şekilde eklendi";
                        }else{
                            $hata="Kayıt sırasında hata meydana geldi";
                        }
                    }
