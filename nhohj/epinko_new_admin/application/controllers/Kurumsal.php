                    ...
                    if ($this->formControl == $this->session->userdata("formCheck")) {
                        if ($veri["err"] != true) {
                            ...
                            $guncelle=$this->m_tr_model->updateTable("table_options",array(
                                ...
                                "bakim_modu_baslik" => $this->input->post("bakim_modu_mesaj"),
                                "bakim_modu_aciklama" => $this->input->post("bakim_modu_aciklama"),
                                "ds_link" => trim($_POST["ds_link"]),
            ...
            if ($_POST) {
                if ($this->formControl == $this->session->userdata("formCheck")) {
                    if ($veri["err"] != true) {
                        ...
                        if($this->input->post("us_1")){
                            $us1=1;
                        }
                        if($this->input->post("us_2")){
                            $us2=1;
                        }
                        if($this->input->post("us_3")){
                            $us3=1;
                        }
                        if($this->input->post("is_1")){
                            $is1=1;
                        }
                        if($this->input->post("is_2")){
                            $is2=1;
                        }
                        if($this->input->post("is_3")){
                            $is3=1;
                        }
