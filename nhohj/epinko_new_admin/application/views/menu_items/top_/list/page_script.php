        ...
        tabless  = $('#kt_datatable').DataTable({
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: [
                        'ssid','anamenuadi','sor','ikons','panem','stat','action'],
                },
            },
            "language":{
            ...
            columns: [
                {data: 'sor',responsivePriority: 1},
                {data: 'ikons',responsivePriority: 1},
                {data: 'anamenuadi',responsivePriority: 2},
                {data: 'panem',responsivePriority: 3},
            ...
            columnDefs: [
                {
                    ...
                    "render": function (data, type, row) {
                        if(row.ikons){
                            return '<i class="' + row.ikons + '"></i></span>';
                        }else{
                            return '-';
                        }
                    }
                    ...
                    "render": function (data, type, row) {
                        if(!row.panem){
                            return '<span class="badge badge-success"><i class="fa fa-home text-white"></i> Ana Menü</span>';
                        }else{
                            if(row.paikon){
                                return '<span class="badge badge-info"><i class="' + row.paikon +' text-white"></i> ' + row.panem + '</span>';
                            }else{
                                return '<span class="badge badge-info"><i class="fa fa-minus text-white"></i> ' + row.panem + '</span>';
                            }
                        }
                    }
                },
...

                {
                    ...
                    searchable:false,
                    render: function(data, type,row) {
                        return '<a href="<?= base_url('ust-menu-guncelle/') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Güncelle">'+
