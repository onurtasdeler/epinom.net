...
<script>
    ...
    $(function () {
        ...
        $ck2<?= $item->id ?> = CKEDITOR.replace('icerik2_<?= $item->id ?>', {
            ...
            filebrowserImageUploadUrl: "<?=base_url();?>imageUplo<?= getcur(); ?>dCK?type=image&CKEditorFuncNum=1&namse=haber-yazi-icerik",
...
<?= getcur(); ?>
        ...
        $("#guncelleForm").on("submit", function (e) {
            ...
            $.ajax({
                ...
                url: "<?= base_url("urun-bayi-guncelle/" . $data["veri"]->id) ?>",
