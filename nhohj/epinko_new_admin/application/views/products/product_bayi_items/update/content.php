                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select name="kategori_id"
                                                            ...
                                                            $bayi=getTableSingle("table_users",array("id" => $data["veri"]->bayi_id));
                                                            ...
                                                            if($cats){
                                                                ...
                                                                foreach ($cats as $item) {
                                                                    ...
                                                                    if($data["veri"]->category_id==$item->id){
                                                                        ...
                                                                        <option selected value="<?= $item->id ?>"><?= $item->c_name." - Bayi:".$bayi->email ?></option>
                                                    ...
                                                    if($data["veri"]->bayi_id!=0){
                                                        ...
                                                        <div class="col-lg-12 mt-3">
                                                            ...
                                                            <div class="alert alert-warning">Bu ürün bayi ürünüdür. <br>



                                                                <b class="text-dark">Bayi Adı</b> : <b class="text-dark"><?= $bayi->full_name ?></b><br>

                                                                <b class="text-dark">Bayi Email</b> : <b class="text-dark"><?= $bayi->email ?></b><br>

                                                                <b class="text-dark">Bayi Komisyon</b> : <b class="text-dark"><?= $bayi->bayi_komisyon ?></b><br>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="alert alert-warning">
                                                            ...
                                                            Hesaplama Güncelleme sağladıktan sonra gösterilecektir.
                                                ...
                                                <div class="row">
                                                    ...
                                                    if($data["veri"]->bayi_id!=0){
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <p style="line-height:30px; "><b style="font-size:9pt;">Satış Fiyatı :<span id="satisText" class="text-success font-weight-bold"> <?= custom_number_format($satis_fiyati)." ".getcur() ?></span></b></p>
                                                            ...
                                                            if($data["veri"]->is_discount==1){
                                                                ...
                                                                <p style="line-height:30px; "><b style="font-size:9pt;">İndirimli Satış Fiyatı :<span id="satisText" class="text-danger font-weight-bold"> <?= custom_number_format($data["veri"]->price_sell_discount)." ".getcur() ?></span></b></p>
                                                            ...
                                                            <p style="line-height:30px; "><b style="font-size:9pt;">Komisyon Oranı :<span id="satisText" class="text-success font-weight-bold"> % <?= custom_number_format($data["veri"]->bayi_kom)?></span></b></p>

                                                            <p style="line-height:30px; "><b style="font-size:9pt;">Komisyon Tutarı :<span id="satisText" class="text-success font-weight-bold">  <?= custom_number_format($data["veri"]->bayi_kom_tutar)." ".getcur() ?></span></b></p>

                                                            <p style="line-height:30px; "><b style="font-size:9pt;">Bayi Net Kazancı:<span id="satisText" class="text-success font-weight-bold"> <?= custom_number_format($data["veri"]->net_kazanc)." ".getcur() ?></span>
