                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select name="kategori_id"
                                                            ...
                                                            $cats=getTableOrder("table_products_category",array("status" => 1,"uye_id !=" =>  0),"c_name","asc");
                                                            ...
                                                            if($cats){
                                                                ...
                                                                foreach ($cats as $item) {
                                                                    ...
                                                                    <option value="<?= $item->id ?>"><?= $item->c_name ?> <?= ($bayi)?" - Bayi:".$bayi->email." - Komisyon: %".$bayi->bayi_komisyon:"" ?></option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="alert alert-info">
                                                            ...
                                                            <i class="fa fa-circle text-danger"></i> Net fiyat girdikten sonra ürünü kaydettiğinizde ürün güncelleme ekranına yönlendireleceksiniz ve bu kısımda gerekli komisyon ve kazanç bilgilerini görebilirsiniz <br>



                                                            Kaydettiğiniz anda komisyon bilgileri otomatik olarak hesaplanacaktır.
