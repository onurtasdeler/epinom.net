                ...
                table.DataTable({
                    ...
                    ajax: {
                        ...
                        data: {
                            ...
                            columnsDef: [
                                'ssid','sorder','p_name','c_name','bayi_id','cekilis_urunu','stat','is_slider_bottom','is_new','is_populer','is_anasayfa','action'],
                        },
                    },
                    "language":{
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                    ...
                                    return '<a href="<?= base_url("uye-guncelle/") ?>'+ row.bayi_link +'">'+ row.bayi_name +' <br> <small>Komisyon: %' +row.bayi_komisyon+ '</small></a>';
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                if(row.stat==0){
                                    return '<span class="badge badge-warning">Pasif</span>';
                                }else if(row.stat==1){
...

                        {
                            ...
                            render: function(data, type,row) {
                                ...
                                '<a href="<?= base_url('urun-bayi-guncelle/') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Güncelle">'+
