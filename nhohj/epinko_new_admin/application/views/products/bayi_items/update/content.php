                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <select name="kategori_id"
                                                            ...
                                                            <?php
                                                            $cats=getTableOrder("table_products_category",array("status" => 1),"c_name","asc");
                                                            if($cats){
                                                            ...
                                                            <div class="card-body text-white">
                                                                <div class="row">
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                foreach($oyunlar as  $row)
                                                                                {
                                                                                    if($data["veri"]->turkpin_id==$row->id){
                                                                                        ?>
                                                                                        <option selected <?=isset($_GET["id"])?$liste[0]->turkpin_kategori_id==$row->id?'selected':'':''?> value="<?=$row->id?>"><?=$row->name?></option>
                                                                                        <?php
                                                                                    }else{
                                                                                        ?>
                                                                                        <option <?=isset($_GET["id"])?$liste[0]->turkpin_kategori_id==$row->id?'selected':'':''?> value="<?=$row->id?>"><?=$row->name?></option>
                                                                                        <?php
                                                                                    }
                                                                                ...
                                                                                ?>
                                                                                <option selected value="">Türkpin ile bağlantı kurulamadı. Lütfen daha sonra tekrar deneyiniz.</option>
                                                                                <?php
                                                                            }
                                                                    ...
                                                                    <div class="col-xl-4" id="turkpinUrunCont">
                                                                        ...
                                                                        try {
                                                                            if($data["veri"]->turkpin_urun_id!=0){
                                                                                ...
                                                                                if($oyunlar){
                                                                                    ?>
                                                                                    <label class="text-white"><b>Türkpin </b>Ürün</label>
                                                                                    <select name="turkpin_urun_id" class="form-control turkpinoyun">
                                                                                        <option value="0">Ürün Seçiniz</option>
                                                                                        <?php
                                                                                        foreach($oyunlar as $row)
                                                                                        {
                                                                                            if($row->id==$data["veri"]->turkpin_urun_id){
                                                                                                ?>
                                                                                                <option selected value="<?=$row->id?>"><?=$row->name?> - Fiyat : (<?=$row->price?>) </option>
                                                                                                <?php
                                                                                            }else{
                                                                                                ?>
                                                                                ...
                                                                                ?>
                                                                                <label class="text-white"><b>Türkpin </b>Ürün</label>
                                                                                <select name="turkpin_urun_id"
                                                                                        class="form-control turkpinoyun">
                                                                                    <option value="0">Önce Türkpin Kategori Seçiniz</option>
                                                                                </select>
                                                                                <?php
                                                                            }
                                                                        }catch (Exception $ex){
                                                                    ...
                                                                    <div class="col-xl-3 mt-5">
                                                                        ...
                                                                        <select class="form-control" id="turkpin_auto_stock" name="turkpin_auto_stock" id="">
                                                                            <?php
                                                                            if($data["veri"]->turkpin_auto_stock==1){
                                                                                ?>
                                                                                <option value="1" selected>Aktif</option>
                                                                                <option value="0">Pasif</option>
                                                                                <?php
                                                                    ...
                                                                    <div class="col-xl-3 mt-5">
                                                                        ...
                                                                        <select class="form-control" name="turkpin_auto_price" id="">
                                                                            <?php
                                                                            if($data["veri"]->turkpin_auto_price==1){
                                                                                ?>
                                                                                <option value="1" selected>Aktif</option>
                                                                                <option value="0">Pasif</option>
                                                                                <?php
                                                                    ...
                                                                    <div class="col-xl-3 mt-5">
                                                                        ...
                                                                        <select class="form-control" id="turkpin_auto_order" name="turkpin_auto_order" id="">
                                                                            <?php
                                                                            if($data["veri"]->turkpin_auto_order==1){
                                                                                ?>
                                                                                <option value="1" selected>Aktif</option>
                                                                                <option value="0">Pasif</option>
                                                                                <?php
                                                                    ...
                                                                    <div class="col-xl-3 mt-5">
                                                                            ...
                                                                            <input type="text"
                                                                                   class="form-control"
                                                                                   required=""  id="turkpin_stok" name="turkpin_stok"
                                                                                   placeholder="Stok Sayısı" value="<?= $data["veri"]->turkpin_stok ?>"/>
                                    ...
                                    <div class="col-xl-12 col-xxl-12">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <p style="line-height:30px;">Stoklu</p>
                                                    </div>
                                                    <div class="col-lg-6">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
