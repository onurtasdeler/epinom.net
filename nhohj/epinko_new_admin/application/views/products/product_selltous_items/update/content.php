<form id="guncelleForm" onsubmit="return false" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <select name="kategori_id"
                                                            ...
                                                            $cats=getTableOrder("table_products_category",array("status" => 1,"is_bizesat"=>1),"c_name","asc");
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label>Alış Fiyatı (<?= getcur() ?>)</label>
                                                                ...
                                                                <input type="number"
                                                                       ...
                                                                       placeholder="Alış Fiyatı (<?= getcur() ?>)"
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label>Satış Fiyatı (<?= getcur() ?>)</label>
                                                                ...
                                                                <input type="number"
                                                                       ...
                                                                       placeholder="Satış Fiyatı (<?= getcur() ?>)"

                                                                       value="<?= $data["veri"]->price_sell ?>"/>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M4.21611835,7.74669402 C4.30015839,7.64056877 4.40623188,7.55087574 4.5299008,7.48500698 L11.5299008,3.75665466 C11.8237589,3.60013944 12.1762411,3.60013944 12.4700992,3.75665466 L19.4700992,7.48500698 C19.5654307,7.53578262 19.6503066,7.60071528 19.7226939,7.67641889 L12.0479413,12.1074394 C11.9974761,12.1365754 11.9509488,12.1699127 11.9085461,12.2067543 C11.8661433,12.1699127 11.819616,12.1365754 11.7691509,12.1074394 L4.21611835,7.74669402 Z" fill="#000000" opacity="0.3"/>
                                    ...
                                    <h4 style="font-size:10pt;" class="card-label">Stok/Fatura</h4>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number"
                                                                   ...
                                                                   placeholder="Alış Stok"

                                                                   value="<?= $data["veri"]->alis_stok ?>"/>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number"
                                                                   ...
                                                                   placeholder="Satış Stok"

                                                                   value="<?= $data["veri"]->stok ?>"/>
