            ...
            var initTable1 = function() {
                ...
                table.DataTable({
                    ...
                    ajax: {
                        ...
                        url: "<?= base_url("product-sell-to-us-list-table".$w) ?>",
                        ...
                        data: {
                            ...
                            columnsDef: [
                                ...
                                'ssid','sorder','p_name','is_deal','c_name','cekilis_urunu','status','is_slider_bottom','is_new','is_populer','is_anasayfa','action'],
                            ...
                            "render": function (data, type, row) {
                                ...
                                if(row.is_deal==1){
                                    ...
                                    return '<span class="switch switch-outline switch-icon switch-success">' +
                                        ...
                                        '<label><input type="checkbox" id="switch-lg_10_'+ row.ssid +'" checked data-url="<?= base_url('urun-veri-guncelle/is_deal/') ?>' + row.ssid + '" ' +

                                        'onchange="durum_degistir(10,'+ row.ssid +')" name="select"><span></span></label></span>';

                                }else{

                                    return '<span class="switch switch-outline switch-icon switch-success">' +

                                        '<label><input type="checkbox" id="switch-lg_10_'+ row.ssid +'"  data-url="<?= base_url('urun-veri-guncelle/is_deal/') ?>' + row.ssid + '" ' +
...

                        {
                            ...
                            render: function(data, type,row) {
                                ...
                                return ' <a href="<?= base_url('urun-ozel-alanlar/') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Özel Alanlar">' +
                                    ...
                                    ' <a href="<?= base_url('bize-sat-urunler?down=') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Aşağı Taşı">' +

                                    '<i class="la la-arrow-down text-primary"></i></a>'+

                                    '<a href="<?= base_url('bize-sat-urunler?up=') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Yukarı Taşı">' +

                                        '<i class="la la-arrow-up text-primary"></i></a>'+

                                '<a href="<?= base_url('bize-sat-urun-guncelle/') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Güncelle">'+
