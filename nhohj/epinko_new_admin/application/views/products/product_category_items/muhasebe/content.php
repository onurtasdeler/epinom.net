    ...
    <div class="d-flex flex-column-fluid" style="margin-top: 15px">
        <div class="container">
            <div class="row">
                    ...
                    <?php
                    $bayi=getTableSingle("table_users",array("uye_category" => $data["v"]->id));
                    if($bayi){
                        ?> <div class="col-lg-12">
                        <div class="alert alert-info">Bu bayiye ait bir kategidir. <br>
                        Bayi <a class="text-warning" href="<?= base_url("uye-guncelle/".$bayi->id) ?>"><?= $bayi->email ?></a> <br>
                        <b>Bayi Komisyon : %<?= $bayi->bayi_komisyon ?></b></div></div>
                        <div class="col-lg-6 mt-4">
                            <div class="card border-3 border-top border-dark">
                                <div class="card-body">
                                    <h5 class="text-muted">Ödenecek Tutar </h5>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1">
                                            <?php
                                            $sorgu2 = $this->m_tr_model->query("SELECT sum(money) as say from category_pay where cat_id = ".$data["v"]->id."   ");
                                            $sorgu = $this->m_tr_model->query("SELECT sum(bayi_net_kazanc) as say from table_orders where bayi_idd=".$bayi->id."  and  status = 2 AND total_price>0 ");
                                            if($sorgu){
                                                if($sorgu[0]->say>0){
                                                    if($sorgu2){
                                                        if($sorgu2[0]->say>0){
                                                            echo ($sorgu[0]->say-$sorgu2[0]->say);
                                                        }else{
                                                            echo (floor((($sorgu[0]->say) * 100)) / 100);
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="card border-3 border-top border-dark">
                                <div class="card-body">
                                    <?php
                                    $tops=0;
                                    $sorgu = $this->m_tr_model->query("SELECT sum(money) as say from category_pay where cat_id = ".$data["v"]->id."   ");
                                    ?>
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="card border-3 border-top border-dark">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                <h5 class="text-muted">Site Kazancı</h5>
                                                <div class="metric-value d-inline-block">
                                                    <h1 class="mb-1">
                                                        <?php
                                                        $sorgu = $this->m_tr_model->query("SELECT sum(komisyon_bayi_tutar) as say from table_orders where bayi_idd=".$bayi->id." and  status = 2 AND total_price>0  and DATE(sell_at) = DATE(CURDATE()) ");
                                                        if($sorgu){
                                                            if($sorgu[0]->say>0){
                                                                echo (floor((($sorgu[0]->say) * 100)) / 100);
                                                            }else{
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="card border-3 border-top border-dark">
                                            <div class="card-body">
                                                ...
                                                $sorgu = $this->m_tr_model->query("SELECT sum(komisyon_bayi_tutar) as say from table_orders where bayi_idd=" . $bayi->id . " and  status = 2 AND total_price>0  and DATE(created_at) = DATE(DATE_SUB(CURDATE(),INTERVAL 1 DAY)) ");
                                                ?>
                                                <h5 class="text-muted">Site Kazancı</h5>
                                                <div class="metric-value d-inline-block">
                                                    <h1 class="mb-1">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="card border-3 border-top border-dark">
                                            <div class="card-body">
                                                ...
                                                $sorgu = $this->m_tr_model->query("SELECT sum(komisyon_bayi_tutar) as say from table_orders where bayi_idd=" . $bayi->id . " and  status = 2 AND total_price>0  and  WEEK(sell_at) = WEEK(CURDATE()) ");
                                                ?>
                                                <h5 class="text-muted">Site Kazancı</h5>
                                                <div class="metric-value d-inline-block">
                                                    <h1 class="mb-1">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="card border-3 border-top border-dark">
                                            <div class="card-body">
                                                ...
                                                $sorgu = $this->m_tr_model->query("SELECT sum(komisyon_bayi_tutar) as say from table_orders where bayi_idd=" . $bayi->id . " and  status = 2 AND total_price>0  and  MONTH(sell_at) = MONTH(CURDATE())  ");
                                                ?>
                                                <h5 class="text-muted">Site Kazancı</h5>
                                                <div class="metric-value d-inline-block">
                                                    <h1 class="mb-1">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="card border-3 border-top border-dark">
                                            <div class="card-body">
                                                ...
                                                $sorgu = $this->m_tr_model->query("SELECT sum(komisyon_bayi_tutar) as say from table_orders where bayi_idd=" . $bayi->id . " and  status = 2 AND total_price>0  and  YEAR(created_at) = YEAR(CURDATE())  ");
                                                ?>
                                                <h5 class="text-muted">Site Kazancı</h5>
                                                <div class="metric-value d-inline-block">
                                                    <h1 class="mb-1">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="card border-3 border-top border-dark">
                                            <div class="card-body">
                                                ...
                                                $sorgu = $this->m_tr_model->query("SELECT sum(komisyon_bayi_tutar) as say from table_orders where bayi_idd=" . $bayi->id . " and  status = 2 AND total_price>0  and     (DATE(sell_at) >= '".$this->input->get("min")."' AND DATE(sell_at)<= '".$this->input->get("max")."' )  ");
                                                ?>
                                                <h5 class="text-muted">Site Kazancı</h5>
                                                <div class="metric-value d-inline-block">
                                                    <h1 class="mb-1">
