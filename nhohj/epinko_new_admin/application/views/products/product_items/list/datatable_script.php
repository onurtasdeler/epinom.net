                ...
                table.DataTable({
                    ...
                    ajax: {
                        ...
                        data: {
                            ...
                            columnsDef: [
                                'ssid','sorder','p_name','iliski','is_deal','c_name','cekilis_urunu','status','is_slider_bottom','is_new','is_populer','is_anasayfa','action'],
                        },
                    },
                    "language":{
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            targets:3,
                            "render": function (data, type, row) {
                                return '<span><span class="label font-weight-bold label-lg  label-light-success label-inline">'+(row.iliski ? row.iliski : '')+'</span></span>';
                                if(row.iliski==""){
