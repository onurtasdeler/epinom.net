                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <select name="kategori_id"
                                                            ...
                                                            $cats=getTableOrder("table_products_category",array("status" => 1,"uye_id" => 0,"is_bizesat"=>0),"c_name","asc");
                                                            ...
                                                            if($cats){
                                                                ...
                                                                foreach ($cats as $item) {
                                                                    ...
                                                                    $bayi=getTableSingle("table_users",array("uye_category" => $item->id));
                                                                    ...
                                                                    <option value="<?= $item->id ?>"><?= $item->c_name ?> <?= ($bayi)?" - Bayi:".$bayi->email."":"" ?></option>
                                                        ...
                                                        <select name="turkpin_kategori_id"
                                                            ...
                                                            try {
                                                                ...
                                                                foreach ($oyunlar as $row) {
                                                                    ...
                                                                    <option <?= isset($_GET["id"]) ? $liste[0]->turkpin_kategori_id == $row->id ? 'selected' : '' : '' ?>
                                                                ...
                                                                <option value="">Türkpin Bağlantısı Kurulamadı. Yeniden Deneyiniz.</option>
                                                    ...
                                                    <div class="col-xl-4 mt-5" id="turkpinUrunCont">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="alert alert-warning">
                                                            ...
                                                            Bayiye ait bir ürün oluştururken <b>Geliş Fiyatı'nı</b> net satış fiyatı olarak giriniz. Girdiğiniz satış fiyatından  bayiye atadığınız komisyon otomatik olarak hesaplanacak kayıt edilecektir.
...
placeholder="Satış Fiyatı" min="0" value=""/>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <p id="karp" style="line-height:30px;display:none"><b>Kar (<?= getcur(); ?>) : </b> <span id="karText" class="text-danger font-weight-bold">Fiyat Giriniz</span></p>



                                                        <p id="indirim_oran" style="line-height:30px;display:none"><b>İndirim (<?= getcur(); ?>) : </b> <span id="indirimText" class="text-danger font-weight-bold">Fiyat Giriniz</span></p>
                                                        ...
                                                        <p style="line-height:30px;"><b style="">Satış Fiyatı (<?= getcur(); ?>) : </b> <span id="satisText" class="text-danger font-weight-bold">Fiyat Giriniz</span></p>



                                                        <p id="indirimli_fiyat" style="line-height:30px; display:none"><b style="font-size:9pt;">İndirimli Fiyatı (<?= getcur(); ?>) : </b> <span id="indText" class="text-danger font-weight-bold">Fiyat Giriniz</span></p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="checkbox"  name="is_fatura">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="checkbox" name="is_anasayfa">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="checkbox"name="is_populer">
