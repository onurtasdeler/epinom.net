                    ...
                    <div class="col-lg-9">
                        ...
                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                            ...
                            <!--end::Svg Icon-->
                                            ...
                                            <h3 class="card-label">Ürün / Sipariş Ayarları</h3>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    <label style="font-weight: 600">Default Max Sepet Adedi <small class="text-info">(Bu alan bir ürünün sepete max kaç adet eklenebileceğini belirler)</small></label>

                                                        <input type="number"
                                                               class="form-control" step="1"
                                                               name="default_sepet"
                                                               placeholder="Default Max Sepet Adedi" value="<?= $data["veri"]->default_max_sepet ?>" >
                                                </div>
                                            </div>
