                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-4 mt-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       required=""
                                                       name="api_user"
                                                       placeholder="API User"  value="<?= $data["veri"]->api_user ?>"/>
                                            </div>
                                            ...
                                            <div class="col-xl-4 mt-4">
                                                <label>Havale Komisyonu (%)</label>
                                                <input type="text"
                                                       class="form-control"
                                                       name="havale_komisyon"
                                                       placeholder="Havale Komisyon"  value="<?= $data["veri"]->havale_komisyon ?>"/>
                                            </div>
