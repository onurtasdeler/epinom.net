                                ...
                                <div class="row" >
                                    <div class="col-xl-12">
										<div class="alert-danger alert">
												Payguru Return URL Adresiniz
												<?php 
												$cel=getTableSingle("options_general",array("id" => 1));
												$cels=md5($cel->site_name."payguru");
												?>
												<br> <h6><?= $cel->site_link."/callback/payguru/".$cels ?></h6>
											</div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-4 mt-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       name="merchant_id"
                                                       placeholder="Merchant ID"  value="<?= $data["veri"]->merchant_id ?>"/>
                                            </div>
                                            ...
                                            <div class="col-xl-4 mt-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       required=""
                                                       name="merchant_key"
                                                       placeholder="Service ID"  value="<?= $data["veri"]->merchant_key ?>"/>
                                            </div>
											...
											<div class="col-xl-4 mt-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       required=""
                                                       name="merchant_salt"
                                                       placeholder="Secret Key"  value="<?= $data["veri"]->merchant_salt ?>"/>
                                            </div>
                                            
                                            <div class="col-xl-4 mt-4">
                                                <label>Mobil Ödeme Komisyonu (%)</label>
                                                <input type="text"
                                                       class="form-control"
