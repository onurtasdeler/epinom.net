<div style="padding:0px" class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <form class="form" autocomplete="off" action="<?= base_url("epinkopin") ?>" method="post" enctype="multipart/form-data">
        <br>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                            ...
                            <i class="fa fa-circle"></i> Kodlar sadece bir kez kullanılabilir.<br>
                            <i class="fa fa-circle"></i> Sistem kod üretirken önceki eklenen kodları kontrol etmektedir. Bu konuda bir problem oluşmayacaktır.
                        </div>
                    </div>
                    <div class="col-lg-12">
...
<div class="col-lg-12">
    <div class="alert alert-success">
        <?= $data["hatayok"] ?>
        <meta http-equiv="refresh" content="1;url=<?= base_url("epinkopin") ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-<?= ($data["v"])?"1":"2" ?>">
                                                        <div class="form-group">
                                                            <label for="">Üretilecek Kod Adedi (Max 50)</label>
                                                            <input type="number" name="say" max="50" value="<?= $data["v"]->adet ?>" required class="form-control form-control" id="say" placeholder="Kullanım Sayısı">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label for=""> Kupon Geçerlilik Tarihi (Boşsa Sınırsız)</label>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            if($data["v"]){
                                                                ...
                                                                <a href="<?= base_url("epinkopin") ?>" type="button" class="btn btn-block w100 mt-5 btn-warning">Vazgeç</a>

                                                                <?php
                                                            }else{
                                                                ?>
                                                                <button type="submit" class="btn btn-block w100 mt-5 btn-success">Random Kupon Oluştur</button>
                                                                <?php
                                                            }
                                                            ?>
                                                        </div>
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                        ...
                        <tbody>
                        <?php
                        $kuponlar=getTableOrder("table_dis_coupon",array("type" => 1),"id","asc");
                        if ($kuponlar) {
                                    ...
                                    <td>
                                        <span class="switch switch-outline switch-icon switch-success">
                                            ...
                                            if ($item->status == "1") {
                                                ...
                                                ?>
                                                <span class="badge badge-success">Kullanıldı <br><br>
                                                <a href="<?= base_url("odeme-bildirim-guncelle/".$item->bildirim_id) ?>" class="text-warning"><b>Logu Görüntüle</b></a></span>
                                                <br>
