                        ...
                        <div class="row ">
                            <div class="col-lg-12">
                                <div class="alert alert-info">
                                    <i class=" fa fa-warning"></i> Toplu Smsler Cron vasıtası ile gönderimektedir. Toplu sms gönderim loglarınızı aşağıdaki alandan görebilirsiniz.
                                    <br>
                            ...
                            <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mt-5">
                                                ...
                                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                                    ...
                                                    <?php
                                                    $grup=getTableOrder("table_user_sms_task",array("type" => 1),"name","asc");
                                ...
                                <div class="card mt-5">
                                    <div class="card-header border-0 pt-6">
                                        <h6><i class="fa fa-history"></i> Toplu SMS Gönderim Kayıt ve Durumları</h6>
                                    </div>
                                    <div class="card-body pt-0">
                                        <div class="row" style="max-height: 300px; min-height: 300px;overflow: hidden;overflow-y: scroll">
                                            <?php
                                            $cek=getTableOrder("t_sms_job_grup",array(),"gonderim_tarih","asc");
                                            if($cek){
                                                ?>
                                                        ...
                                                        foreach ($cek as $item) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-start " style="padding-left: 0">
                                                                    <?= getTableSingle("table_user_sms_task",array("id" => $item->sablon_id))->name ?>
                                                                </td>
                                                                <td class="text-start " style="padding-left: 0">
                                                                ...
                                                                <td class="text-start " style="padding-left: 0">
                                                                    ...
                                                                    if($item->status==0){
                                                                        ...
                                                                        $say1=$this->m_tr_model->query("select * from t_sms_job where status=1 and job_grup_id=".$item->id);
                                                                        $say2=$this->m_tr_model->query("select * from t_sms_job where status=2 and job_grup_id=".$item->id);
                                                                        if($say1){
                                                                ...
                                                                <td class="text-start " style="padding-left: 0">
                                                                    ...
                                                                    if($item->status==0){
                                                                        ?>
                                                                        <a href="<?= base_url("sms/sms/index?sil=".$item->id) ?>" class="btn btn-danger btn-sm">İptal Et</a>
                                                                        <?php
                                                                    }else if($item->status==1){
                                                                        ?>
                                                                        -
