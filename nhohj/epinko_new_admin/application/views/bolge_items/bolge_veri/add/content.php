                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   placeholder="Ör: flag-icon flag-icon-tr" value=""/>
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-xl-4">
                                                    ...
                                                    foreach ($getLang as $item) {
                                                        if ($say2 == 0) {
                                                            ...
                                                            <div class="tab-pane fade show active"
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Ülke ( <?= $item->name ?> )</label>
                                                                    <input type="text"
                                                                           class="form-control"
                                                                           required="" id="link_<?= $item->id ?>" name="link_<?= $item->id ?>"
                                                                           placeholder="Almanya" value=""/>
                                                                </div>
                                                            </div>
