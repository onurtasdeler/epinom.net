...
<script src="<?= base_url() ?>assets/pickr.min.js"></script>

<script src="<?= base_url() ?>assets/form-pickers.init.js"></script>

<script src="<?=base_url() ?>assets/kodla/select2/select2.min.js"></script>

<script src="<?=base_url() ?>assets/kodla/tippyjs/popper.min.js"></script>

<script src="<?=base_url() ?>assets/kodla/tippyjs/tippy-bundle.umd.min.js"></script>
