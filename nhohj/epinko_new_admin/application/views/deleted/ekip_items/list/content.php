        ...
        <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($item->image!=""){
                                            ...
                                            <div class="symbol symbol-90 mr-3">
                                                <img src="../upload/ekip/<?= $item->image ?>" alt="">
                                            </div>
                                    ...
                                    <td>
                                        <span class="switch switch-outline switch-icon switch-success">
                                            ...
                                            ?>
                                            <label>
                                                <input type="checkbox" id="switch-lg_<?= $item->id ?>" <?= $check ?> data-url="<?= base_url('ekip-durum-guncelle/' . $item->id) ?>"
                                    ...
                                    <td nowrap="nowrap">
                                        <a href="<?= base_url('ekip?down='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Aşağı Taşı">
                                            <i class="la la-arrow-down text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('ekip?up='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Yukarı Taşı">
                                            <i class="la la-arrow-up text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('ekip-guncelle/'.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Güncelle">
                    ...
                    <?php
                    createModal("Ekip Sil", "Ekip Üyesini silmek istediğinize emin misiniz?", 1, array("Sil", "sosyal_delete()", "btn-danger", "fa fa-trash"));
                    ?>
                    <!--end: Datatable-->
                </div>
            </div>
