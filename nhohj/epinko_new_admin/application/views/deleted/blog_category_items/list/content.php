                        ...
                        if ($data) {
                            ...
                            foreach ($data as $item) {
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <a href="<?= base_url('blog-kategoriler?down='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Aşağı Taşı">
                                            <i class="la la-arrow-down text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('blog-kategoriler?up='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Yukarı Taşı">
                                            <i class="la la-arrow-up text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('blog-kategori-guncelle/'.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Güncelle">
