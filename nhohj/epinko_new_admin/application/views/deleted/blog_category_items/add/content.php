                                                                        ...
                                                                        if ($say2 == 0) {
                                                                            ...
                                                                            <div class="tab-pane fade show active"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label>Kategori Adı ( <?= $item->name ?> )</label>
                                                                                    <input type="text"
                                                                                           class="form-control"
                                                                                           required="" id="kategori_adi_<?= $item->id ?>" name="kategori_adi_<?= $item->id ?>"
                                                                                           placeholder="Kategori Adı" value=""/>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label>Kategori Link ( <?= $item->name ?> )</label>
                                                                                    <input type="text"
                                                                                           class="form-control"
                                                                                           required="" id="kategori_link_<?= $item->id ?>" name="kategori_link_<?= $item->id ?>"
                                                                                           placeholder="Kategori Link" value=""/>
                                                                                </div>
