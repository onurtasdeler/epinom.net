                        ...
                        if ($data) {
                            ...
                            foreach ($data as $item) {
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <a href="<?= base_url('hizmetler?down='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Aşağı Taşı">
                                            <i class="la la-arrow-down text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('hizmetler?up='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Yukarı Taşı">
                                            <i class="la la-arrow-up text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('hizmetler/'.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Alt Hizmetler">
                                            <i class="la la-list text-dark"></i>
                                        </a>
