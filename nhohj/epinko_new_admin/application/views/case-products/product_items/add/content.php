                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <a href="#" onclick="deleteModal(<?= $data["veri"]->id ?>,1)"
                                                   ...
                                                   data-toggle="modal" data-id="' + row.id + '" data-target="#menu"><i
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <label><b>Kasa Adı (Tanımlayıcı)</b></label>
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               placeholder="Kasa Adı" value=""/>

                                                    </div>

                                                    <div class="col-xl-4">

                                                        <label>Kasa Tutarı</label>
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               placeholder="Kasa Tutarı" value="<?= $data["veri"]->price ?>"/>
