...
<?= getcur(); ?>
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
<?= getcur(); ?>
                                                                                                           class="form-control"<?= getcur(); ?>

                                                                                                           id="<?= getcur(); ?>isa_aciklama_<?= $item->id ?>"
<?= getcur(); ?>
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <p id="karp" style="line-height:30px;display:none"><b>Kar (₺) : </b> <span id="karText" class="text-danger font-weight-bold">Fiyat Giriniz</span></p>
