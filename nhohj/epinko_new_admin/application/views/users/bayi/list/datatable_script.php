        ...
        var KTDatatablesDataSourceAjaxServer = function() {
            ...
            var initTable1 = function() {
                ...
                table.DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?= base_url("bayi-list-table") ?>",
                        type: 'POST',
                        data: {
                            // parameters for custom backend script demo
                            columnsDef: [
                                'ssid','full_name','email','nick_name',"tc_onay","email_onay","tel_onay",'created_at','balance','status','action'],
                        },
                    },
                    "language":{
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                ...
                                if(row.balance==0){
                                    return '<span><span class="label font-weight-bold label-lg  label-light-danger label-inline">'+ row.balance +' '+ row.currency + '</span></span>';
                                }else{
                                    return '<span><span class="label font-weight-bold label-lg  label-light-success label-inline">'+ row.balance +' '+ row.currency + '</span></span>';
                                }
                            }
                        },
                        {
                       ...
                       /* {
...

                        {
                            ...
                            searchable:false,
                            render: function(data, type,row) {
                                return '<a href="<?= base_url('bayi-urunler/')   ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Ürünler">'+
                                    '<i class="la la-box text-info"></i></a>'+
                                    '<a href="<?= base_url('bayi-siparis/') ?>'+ row.ssid +'" class="btn btn-sm btn-clean btn-icon" title="Siparişler">'+
                                    '<i class="la la-shopping-basket text-primary"></i></a>'+
