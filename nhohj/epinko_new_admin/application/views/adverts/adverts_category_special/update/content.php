                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                ...
                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/General/Clipboard.svg--><svg
                                    ...
                                    <h3 class="card-label">Genel Bilgiler - <?= $data["veri"]->name ?></h3>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    <div class="col-xl-3">
                                                        <label>Özel Alan Adı (Tanımlayıcı)</label>
                                                        <input type="text"
                                                               class="form-control"
                                                               required="" id="name" name="name"
                                                               placeholder="Özel Alan Adı" value="<?= $data["veri"]->name ?>"/>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select class="form-control" name="kat" >
                                                            ...
                                                            foreach ($cek as $item) {
                                                                $ana=getTableSingle("table_advert_category",array("id" => $item->top_id,"status" => 1));

                                                                if($data["veri"]->p_id==$item->id){
                                                                    ?>
                                                                        <option selected value="<?= $item->id ?>"> <?= $ana->name ?> > <?= $item->name ?></option>
                                                                    <?php
                                                                }else{
                                                                    ?>
                                                                        <option value="<?= $item->id ?>"><?= $ana->name ?> > <?= $item->name ?></option>
                                                                    <?php
                                                                }
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select class="form-control" name="types" id="secimSecenek">
                                                                ...
                                                                <option value="2" selected>Seçim Alanı</option>
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select class="form-control" name="is_required" >
                                                            ...
                                                            if($data["veri"]->is_required==1){
                                                                ...
                                                                <option value="0" selected>Zorunlu Değil</option>
                                                                <?php
                                                            }
                                                            ?>
                                                                                    ...
                                                                                    <div class="tab-pane fade show active"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                ...
                                                                                                <div class="form-group secenekler" style="<?= ($data["veri"]->type==1)?"display:none":"" ?>">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                           ...
                                                                                                           placeholder="Özel Alan Seçenekler"
                                                                                                           value="<?= $secenekler ?>"/>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
