                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select required class="form-control" name="kat" id="">
                                                            <option value="" selected>Seçiniz</option>
                                                            <?php
                                                            $cek=getTableOrder("table_advert_category",array("status" => 1,"parent_id" => 0),"top_id","asc");
                                                            foreach ($cek as $item) {
                                                                if($item->top_id!=0){
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <select class="form-control" name="types" id="secimSecenek">
                                                            <option selected value="2">Seçim Alanı</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xl-3">
