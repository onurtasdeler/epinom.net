                                                ...
                                                <div class="form-group row">
                                                   <div class="col-xl-6">
                                                       <div class="form-group">
                                                           <label> Süre Adı (Tanımlayıcı)</label>
                                                           <input type="text"
                                                                  class="form-control"
                                                                  required=""
                                                                  id="name"
                                                                  name="name"
                                                                  placeholder="Süre Adı (Tanımlayıcı)"
                                                                  value=""/>
                                                       </div>
                                                   </div>
                                                    <div class="col-xl-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number"
                                                                   ...
                                                                   id="sure"
                                                                   name="sure"
                                                                   placeholder="Sure (saat cinsinde)"
                                                                   value=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3">
                                                                                ...
                                                                                if ($say2 == 0) {
                                                                                    ...
                                                                                    <div class="tab-pane fade show active"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-lg-12">
                                                                                                <div class="form-group">
                                                                                                    <label>Teslimat Süresi ( <?= $item->name ?>
                                                                                                        )</label>
                                                                                                    <input type="text"
                                                                                                           class="form-control"
                                                                                                           id="name_<?= $item->id ?>"
                                                                                                           name="name_<?= $item->id ?>"
                                                                                                           placeholder="Ör: 1 Saat"
                                                                                                           value=""/>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
