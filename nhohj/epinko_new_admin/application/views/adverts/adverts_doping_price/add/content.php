    ...
    <div class="d-flex flex-column-fluid">
                                                ...
                                                <div class="form-group row">
                                                   <div class="col-xl-4">
                                                       <div class="form-group">
                                                           <label>Doping Adı <Tanımlayıcı></Tanımlayıcı></label>
                                                           <input type="text"
                                                                  class="form-control"
                                                                  required=""
                                                                  id="name"
                                                                  name="name"
                                                                  placeholder="Doping Adı (Tanımlayıcı)"
                                                                  value=""/>
                                                       </div>
                                                   </div>
                                                    <div class="col-xl-4">
                                                        <div class="form-group">
                                                            <label>Doping Fiyatı (<?= getcur(); ?>)</label>
                                                            <input type="text"
                                                                   class="form-control"
                                                                   required=""
                                                                   id="price"
                                                                   name="price"
                                                                   placeholder="Doping Fiyatı"
                                                                   value=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2">
                                                        <div class="form-group">
                                                            <label>Doping Süresi (Gün)</label>
                                                            <input type="text"
                                                                   class="form-control"
                                                                   required=""
                                                                   id="sure"
                                                                   name="sure"
                                                                   placeholder="Doping Süresi gün"
                                                                   />
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2">
        ...
        <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
            ...
            <li class="nav-item mb-2" data-toggle="tooltip" title="" data-placement="left" data-original-title="Vazgeç">
                <a class="btn btn-sm btn-icon btn-bg-light btn-icon-danger btn-hover-danger" href="<?= base_url($this->baseLink) ?>">
