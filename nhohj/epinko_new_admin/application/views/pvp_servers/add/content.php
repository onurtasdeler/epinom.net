                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <input type="text"
                                                            class="form-control"
                                                            id="tarih" name="tarih"
                                                            placeholder="Tarih" value="<?= date('Y-m-d') ?>" />
                                                    </div>
                                                    <div class="col-xl-3">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <input type="text"
                                                            class="form-control"
                                                            id="link" name="link"
                                                            placeholder="Ürünler Link" value="" />
                                                    </div>
                                                    <div class="col-xl-3">
