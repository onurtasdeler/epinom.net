                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    <div class="col-xl-3">
                                                        <label>Server Adı (Tanımlayıcı)</label>
                                                        <input type="text"
                                                            class="form-control"
                                                            id="name" name="name"
                                                            placeholder="Server Adı"
                                                            value="<?= $data["veri"]->name ?>" />
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Official Tarih</label>
                                                        <input type="text"
                                                            class="form-control"
                                                            id="tarih" name="tarih"
                                                            placeholder="tarih" value="<?= $data["veri"]->tarih ?>" />
                                                    </div>

                                                    <div class="col-xl-3">
                                                        <label>Beta Tarih</label>
                                                        <input type="text"
                                                            class="form-control"
                                                            id="beta" name="beta"
                                                            placeholder="Beta Tarih" value="<?= $data["veri"]->beta ?>" />
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Tür</label>
                                                        <input type="text"
                                                            class="form-control"
                                                            id="tur" name="tur"
                                                            placeholder="Tür" value="<?= $data["veri"]->tur ?>" />
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Ürünler Link</label>
                                                        <input type="text"
                                                            class="form-control"
                                                            id="link" name="link"
                                                            placeholder="Ürünler Link" value="<?= $data["veri"]->link ?>" />
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Güvenlik</label>
                                                        <input type="text"
                                                            class="form-control"
                                                            id="tur" name="security"
                                                            placeholder="Güvenlik" value="<?= $data["veri"]->security ?>" />
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Durum</label>
                                                        <select name="durum" class="form-control">
                                                            <option value="0" <?= $data["veri"]->durum == 0 ? 'selected' : '' ?>>Yayında Değil</option>
                                                            <option value="1" <?= $data["veri"]->durum == 1 ? 'selected' : '' ?>>Yayında</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <!--begin::Input-->
