        ...
        <div class="container">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    createModal("Sipariş Sil", "Siparişi silmek istediğinize emin misiniz? <br> Siparişi sildiğiniz takdirde siparişe ait ödeme kaydı,talep vb. içerikler silinecektir. <br> İlan Stoklu ise stoklar satıcıya geri yüklenecektir. 

                    <br> Silme işlemi gerçek olarak yapılmaz herhangi bir durum için db'de tutuluyor olacaktır.", 1, array("Sil", "sosyal_delete()", "btn-danger", "fa fa-trash"));
