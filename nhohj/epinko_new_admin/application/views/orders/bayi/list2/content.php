                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="card card-custom  bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url()">
                                ...
                                <div class="card-body my-4">
                                    ...
                                    $cek=$this->m_tr_model->query("select sum(total_price) as say from table_orders where   bayi_idd!=0 and status=2");
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="card card-custom  bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url()">
                                ...
                                <div class="card-body my-4">
                                    ...
                                    $cek=$this->m_tr_model->query("select sum(bayi_net_kazanc) as say from table_orders where   bayi_idd!=0 and status=2");
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="card card-custom  bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url()">
                                ...
                                <div class="card-body my-4">
                                    ...
                                    $cek=$this->m_tr_model->query("select sum(komisyon_bayi_tutar) as say from table_orders where   bayi_idd!=0 and status=2");
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="card card-custom  bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url()">
                                ...
                                <div class="card-body my-4">
                                    ...
                                    $cek=$this->m_tr_model->query("select count(*) as say from table_orders where   bayi_idd!=0 and status=2");
