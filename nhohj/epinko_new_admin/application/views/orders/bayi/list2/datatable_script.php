        ...
        var KTDatatablesDataSourceAjaxServer = function() {
            ...
            var initTable1 = function() {
                ...
                table.DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?= base_url("order-bayi-list-table") ?>",
                        type: 'POST',
                        data: {
                            // parameters for custom backend script demo
                            columnsDef: [
                                'ssid','full_name',"sipNo",'nick_name',"product_id",'image_urun','cat_name','quantity','price','bayi_id','bayi','user_id','status','cdate','action'],
                        },
                    },
                    "language":{
                    ...
                    columnDefs: [
                        {
                            ...
                            targets:3,
                            "render": function (data, type, row) {
                                return '<span style="height:auto;" class="label label-inline label-light-primary font-weight-bold"><a href="<?= base_url("uye-guncelle/") ?>' + row.bayi_id +'" /><i class="fa fa-user" style="color:#3699FF; font-size:10pt;"></i>&nbsp ' + row.bayi + "</a></span>";
                            }
                        },
                        /*{
                            orderable:false,
