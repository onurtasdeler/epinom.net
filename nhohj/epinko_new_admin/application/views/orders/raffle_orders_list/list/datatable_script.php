                    ...
                    ajax: {
                        ...
                        data: {
                            ...
                            columnsDef: [
                                ...
                                'ssid','full_name',"sipNo",'nick_name',"price_discount","product_id",'image_urun','cat_name','quantity','price','user_id','is_raffle','status','cdate','invoice_id','invoice_date','action'],
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                ...
                                if(row.is_raffle==1){
                                    ...
                                    return '<span style="height:auto;" class="label label-inline label-light-secondary font-weight-bold">Kasa Ödülü</span>';
