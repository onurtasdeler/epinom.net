        ...
        <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-body">
                                ...
                                <tr>
                                        ...
                                        if($item->check_epinko==1){
                                          ?>
                                            <div class="symbol symbol-90 mr-3">
                                                <img src="https://epinko.com/public/news/<?= $item->image ?>" alt="">
                                            </div>
                                            <?php
                                        }else{
                                            if($item->image!=""){
                                                ?>
                                                <div class="symbol symbol-90 mr-3">
                                                    <img src="../upload/blog/<?= $item->image ?>" alt="">
                                                </div>
                                    ...
                                    <td>
                                        <span class="switch switch-outline switch-icon switch-success">
                                            ...
                                            ?>
                                            <label>
                                                <input type="checkbox" id="switch-lg_<?= $item->id ?>" <?= $check ?> data-url="<?= base_url('blog-durum-guncelle/' . $item->id) ?>"
                                    ...
                                    <td nowrap="nowrap">
                                        <a href="<?= base_url('blog?down='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Aşağı Taşı">
                                            <i class="la la-arrow-down text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('blog?up='.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Yukarı Taşı">
                                            <i class="la la-arrow-up text-primary"></i>
                                        </a>
                                        <a href="<?= base_url('blog-guncelle/'.$item->id) ?>" class="btn btn-sm btn-clean btn-icon" title="Güncelle">
                    ...
                    <?php
                    createModal("Haber Sil", "Haberi silmek istediğinize emin misiniz?", 1, array("Sil", "sosyal_delete()", "btn-danger", "fa fa-trash"));
                    ?>
                    <!--end: Datatable-->
                </div>
            </div>
