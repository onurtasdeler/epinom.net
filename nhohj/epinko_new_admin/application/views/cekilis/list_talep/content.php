        ...
        <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <?php
                    createModal("Çekiliş Yetki Talebi Sil", "Çekiliş yetki talebini silmek istediğinize emin misiniz?", 1, array("Sil", "sosyal_delete()", "btn-danger", "fa fa-trash"));
                    createModal("Çekiliş Yetki Ver", "Yukarıdaki üye çekiliş oluşturmak için yetki verilecektir. Emin misiniz?", 1, array("Yetki Ver", "yetkiIslem()", "btn-success", "fa fa-check"),"menu2");
                    createModal("Çekiliş Yetki Reddet", "Yukarıdaki üye çekiliş oluşturmak için yetki isteği reddedilecektir. Emin misiniz ?", 1, array("Yetki Reddet", "yetkiIslem(2)", "btn-danger", "fa fa-times"),"menu3",array("name" => "red_nedeni","place" => "Red Nedeni"));
                    ?>
                    <!--end: Datatable-->
                </div>
            </div>
