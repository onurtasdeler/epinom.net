        ...
        <div class="row g-5">
            ...
            if($altaltkategori=="a" && $altkategori!="a"){
                ...
                if($uniq->parent_id==0){
                    ...
                    $veriler=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$uniq->id."  and ilan.is_doping=1 and ilan.is_delete=0"," order by rand() ", 0,24);

                }else{

                    $veriler=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$uniq->parent_id." and category_parent_id=".$uniq->id." and ilan.is_doping=1 and ilan.is_delete=0"," order by rand() ", 0,24);
                ...
                if($uniq->parent_id==0){
                    ...
                    $verilerNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$uniq->id."  and ilan.is_doping=0 and ilan.is_delete=0"," order by   rand() ", $pageAdsNormal,$pageAdsNormalLimit);

                }else{

                    $verilerNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$uniq->parent_id." and category_parent_id=".$uniq->id."  and ilan.is_doping=0 and ilan.is_delete=0"," order by   rand() ", $pageAdsNormal,$pageAdsNormalLimit);
                ...
                if($verilerNormal){
                    ...
                    if($uniq->parent_id==0){
                        ...
                        $sonrasiNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$uniq->parent_id."  and  ilan.is_doping=0 and ilan.is_delete=0"," order by  rand() ", $sorgu2,$pageAdsNormalLimit);

                    }else{

                        $sonrasiNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$uniq->parent_id."  and category_parent_id=".$uniq->id." and ilan.is_doping=0 and ilan.is_delete=0"," order by  rand() ", $sorgu2,$pageAdsNormalLimit);
                ...
                $veriler=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$altaltkategori." and ilan.category_parent_id=".$uniq->id." and ilan.is_doping=1 and ilan.is_delete=0"," order by rand() ", 0,24);
                ...
                $verilerNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$altaltkategori." and ilan.category_parent_id=".$uniq->id." and ilan.is_doping=0 and ilan.is_delete=0"," order by   rand() ", $pageAdsNormal,$pageAdsNormalLimit);

                if($verilerNormal){

                    $sorgu2=$pageAdsNormal+24;

                    $sonrasiNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->top_id." and ilan.category_top_id=".$altaltkategori." and ilan.category_parent_id=".$uniq->id." and ilan.is_doping=1 and ilan.is_delete=0"," order by  rand() ", $sorgu2,$pageAdsNormalLimit);
                ...
                $veriler=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->id." and ilan.category_top_id=0 and ilan.category_parent_id=0 and ilan.is_doping=1 and ilan.is_delete=0"," order by rand() ", 0,24);
                ...
                $verilerNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->id." and ilan.category_top_id=0 and ilan.category_parent_id=0 and ilan.is_doping=0 and ilan.is_delete=0"," order by   rand() ", $pageAdsNormal,$pageAdsNormalLimit);

                if($verilerNormal){

                    $sorgu2=$pageAdsNormal+24;

                    $sonrasiNormal=$this->ads_model->get_ads_list("and ilan.category_main_id=".$uniq->id." and ilan.category_top_id=0 and ilan.category_parent_id=0 and ilan.is_doping=1 and ilan.is_delete=0"," order by  rand() ", $sorgu2,$pageAdsNormalLimit);
