...
if ($this->input->get("type")) {
    ...
    if ($temizle == "waiting") {
        ...
        $getTable = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 1, "is_raffle"=>0));
    } else if ($temizle == "pending") {
        $text = ((lac() == 1) ? "Hazırlanan Siparişler" : "Process Orders");
        $getTable = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 3, "is_raffle"=>0));
    } else if ($temizle == "completed") {
        $text = ((lac() == 1) ? "Tamamlanan Siparişler" : "Completed Orders");
        $getTable = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 2, "is_raffle"=>0));
    } else if ($temizle == "cancelled") {
        $text = ((lac() == 1) ? "İptal Edilen Siparişler" : "Cancelled Orders");
        $getTable = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 5, "is_raffle"=>0));
    } else {
        redirect(b() . gg());
    }
} else {
    $text = ((lac() == 1) ? "Tüm Siparişler" : "All Orders");
    $getTable = getTable("table_orders", array("user_id" => getActiveUsers()->id,"is_raffle"=>0));
}
            ...
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-white">
                        <?php
                        $ce = getTable("table_orders", array("user_id" => getActiveUsers()->id, "is_delete" => 0, "is_raffle"=>0));
                        if ($ce) {
                            if ($_SESSION["lang"] == 1) {
        ...
        <div class="top-seller-inner-one  bg-success    explore w-100">
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-white">
                        <?php
                        $ce = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 2, "is_delete" => 0));
                        if ($ce) {
                            if ($_SESSION["lang"] == 1) {
                                echo "Toplam " . count($ce) . " Sipariş";
                            } else {
            ...
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-muted">
                        <?php
                        $ce = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 3, "is_delete" => 0));
                        if ($ce) {
                            if ($_SESSION["lang"] == 1) {
                                echo "Toplam " . count($ce) . " Sipariş";
                            } else {
            ...
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-white">
                        ...
                        <?php
                        $ce = getTable("table_orders", array("user_id" => getActiveUsers()->id, "status" => 5, "is_delete" => 0));
                        if ($ce) {
                            if ($_SESSION["lang"] == 1) {
                                echo "Toplam " . count($ce) . " Sipariş";
                            } else {
                                    ...
                                    <table class="table  upcoming-projects table-hover table-striped " id="kt_datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 15% !important;"><?= ($_SESSION["lang"] == 1) ? "Br. Fiyat" : "Un. Price" ?></th>
                                                <th style="width: 10% !important;"><?= ($_SESSION["lang"] == 1) ? "Adet" : "Quantity" ?></th>
