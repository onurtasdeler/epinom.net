...
<script>
    ...
    $(document).ready(function (){
        ...
        table.DataTable({
            ...
            order: [[6, "desc"]],
            ajax: {
                url: "<?= base_url("get-list-my-orders?t=".$text) ?>",
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'sipNo','p_name','total','link','total_price','ptok','stat','oprice','qt','cd','action'],
                },
            },
            columns: [
                {data: 'sipNo',orderable: true, searchable: false, responsivePriority:0},
                {data: 'p_name', orderable: true, searchable: false,},
                {data: 'oprice', responsivePriority: 0},
                {data: 'qt', responsivePriority: -2},
                {data: 'total_price', responsivePriority: -2},
                {data: 'stat', responsivePriority: -2},
                {data: 'cd', responsivePriority: -2},
            ...
            columnDefs: [
...

                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        return "<div class='row'><div class='col-lg-3'><a style='font-size: 14px;text-decoration: none;' href='" + row.link + "' target='_blank'><i class='fa fa-external-link'></i> #" + row.p_name + "</a> </div>";
                    }
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if(row.stat==2){
                            ...
                            return  '<a class=" btn-grad  mb-4 " onclick="modalShow(\'' + row.sipNo + '\',\'' + row.ptok + '\')" href="#" class="text-warning" style="justify-content: start; text-align: center !important;display:inline-block; text-decoration:none;padding-left:7px !important;padding-right:7px !important;"  title="Güncelle"><i class="fa fa-search"></i> Kodu Gör</a> &nbsp; ' +
                                    '<a class=" btn-grad  mb-4 " onclick="modalShowRating(\'' + row.sipNo + '\',\'' + row.ptok + '\')" class="text-warning" style="justify-content: start; text-align: center !important;display:inline-block; text-decoration:none;padding-left:12px !important;padding-right:12px !important;"><img style="width:20px!important" src="<?= base_url("assets/img/icon/rating.png") ?>"></a>' ;
                        }else if(row.stat==1){
                            return  '<a onclick="modalShow(\'' + row.sipNo + '\',\'' + row.ptok + '\')" href="#" class="text-warning" style="margin-right:10px;cursor:pointer; text-decoration:none"  title="Güncelle"><i class="fa fa-search"></i> </a> &nbsp; ' ;
                        }else if(row.stat==3){
                            return  '<a onclick="modalShow(\'' + row.sipNo + '\',\'' + row.ptok + '\')" href="#" class="text-warning" style="margin-right:10px;cursor:pointer; text-decoration:none"  title="Güncelle"><i class="fa fa-search"></i> </a> &nbsp; ' ;
                        }else if(row.stat==5){
                            return  '<a onclick="modalShow(\'' + row.sipNo + '\',\'' + row.ptok + '\')" href="#" class="text-warning" style="margin-right:10px;cursor:pointer; text-decoration:none"  title="Güncelle"><i class="fa fa-search"></i> </a> &nbsp; ' ;
