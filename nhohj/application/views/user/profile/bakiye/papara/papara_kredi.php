                    ...
                    <form class="row" action="#">
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <img style="width: 100%;height:60px"
                                         src="<?= base_url("assets/images/pap.png ") ?>"
                                         class="img-fluid" alt="">
                        ...
                        <div class="col-md-3">
                            <div class="input-box pb--20">
                                ...
                                <input id="pricePaparaCredi" step="0.1" min="1" max="10000"
                        ...
                        <div class="col-md-12 col-xl-12">
                            <button title="" href="javascript:;" id="btnPaparaCredit" class="btn-grad  mb-4" style="justify-content: start; text-align: center !important;padding-left: 10px !important;padding-right: 10px !important">
