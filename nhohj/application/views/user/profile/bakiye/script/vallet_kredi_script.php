<script>
    ...
    table.DataTable({
        ...
        order: [[1, "desc"]],
        ajax: {
            url: "<?= base_url("get-payment-list/vallet") ?>",
            type: 'POST',
            data: {
...

            {
                ...
                render: function (data, type, row) {
                    if(row.durum==0){
                        ...
                        return '<a  href="' + row.link + '" type="button" target="_blank" id="" class="btn btn-success btn-small " style="margin-right: 10px;text-decoration:none"><i class="fa fa-check"></i> Ödendi - Detay </a>';
                    }else if (row.durum==2){
                        return '<a  href="' + row.link + '" type="button" target="_blank" id="" class="btn btn-danger btn-small " style="margin-right: 10px;text-decoration:none"><i class="fa fa-times"></i> Ödenmedi - Detay </a>';
                    }else{
    ...
    $('#priceValletCredi').on('input', function() {
        var input = $(this);
        var value = input.val();
