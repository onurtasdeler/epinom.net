...
if ($payguru->status == 1) {
    if($this->input->get("t")){
        if($this->input->get("t")=="payguru-success"){
            ?>
            ...
            <div class="col-lg-12">
                <div class="alert alert-success d-flex align-items-center justify-content-center" style="flex-direction: column">
                    ...
                    <meta http-equiv="refresh" content="2;URL=<?=  base_url($bakiye->link."/mobil/payguru") ?>">
            ...
            <?php
        }else if($this->input->get("t")=="payguru-fail"){
                ?>
                <div style="padding-left: 0px; padding-right: 0px" class="col-xxl-12 mt-4 col-lg-12 col-md-12 col-12 col-sm-12 ">
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <form class="row" action="#">
                            ...
                            <div class="row">
                                <div class="col-lg-1">
                                    <img style="width: 60px;height:60px"
                                         src="<?= base_url("assets/images/payguru.png ") ?>"
                                         class="img-fluid" alt="">
                                ...
                                <div class="col-lg-11">
                                    <div class="content">
                                        <h6 style="font-size: 18px;"
                                            class="title mb-1"><?= ($_SESSION["lang"] == 1) ? "Payguru Mobil Ödeme" : "Payguru Mobile Payment" ?></h6>
                        ...
                        <div class="col-md-3">
                            <div class="input-box pb--20">
                                ...
                                <input id="pricePayguruCredi" class="pricePayguruCredi" step="0.1" min="1" max="10000"
                        ...
                        <div class="col-lg-12" id="PayguruCreditIframe" style="display: none;">

                        </div>
                        <div class="col-md-12 col-xl-12">
                            <a href="javascript:;" id="btnPayguruCredit" class="btn-grad  mb-4" style="justify-content: start; text-align: center !important;padding-left: 10px !important;padding-right: 10px !important">
