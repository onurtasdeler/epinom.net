...
?>
                        ...
                        <form action="" method="post" class="mt-1" onsubmit="return false" id="ilanCreateForm"
                            ...
                            <div class="row mb-4 d">
                                        ...
                                        <div class="col-lg-4 marginCustom" style="position:relative;">
                                            ...
                                            <select class="form-control selects" id="mainCategory" name="mainCat"
                                                ...
                                                if ($c) {
                                                    ...
                                                    ?>
                                                    <option selected
                                                            value="<?= $c->id ?>"><?= $ll->name . " (Komisyon: %" . $c->commission . ") " ?></option>
                                                    <?php
                                        ...
                                        <div class="col-lg-6">
                                            <div class="col-lg-12">
                                                <div class="input-box pb--20">
                                                    <?php
                                                    $siparis=getTableSingle("table_orders_adverts",array("advert_id" => $uniq->id,"status != " => 4 ));
                                                    if($siparis){
                                                        ?>
                                                        <label for="nametr" class="form-label"><?= langS(79) ?>    <small class="text-danger">(<?= ($_SESSION["lang"] == 1) ? "Değiştirilemez" : "Not Changed" ?>
                                                                )</small> (TR)</label>
                                                        <input type="text" name="nametr" id="nametr" disabled readonly
                                                               data-msg="<?= langS(8, 2) ?>"
                                                               value="<?= $uniq->ad_name ?>"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="input-box pb--20">
                                                    ...
                                                    if($siparis){
                                                        ?>
                                                        <label for="nameen" class="form-label"><?= langS(79) ?>    <small class="text-danger">(<?= ($_SESSION["lang"] == 1) ? "Değiştirilemez" : "Not Changed" ?>
                                                                )</small> (TR)</label>
                                                        <input type="text" name="nameen" id="namen" disabled readonly
                                                               data-msg="<?= langS(8, 2) ?>"
                                ...
                                <div class="col-md-12 column deleted">
                                    ...
                                    <div class="col-lg-12 col-12 deleted mt-3">
                                        <div class="row">
                                                        ...
                                                        <div class="content">
                                                            <div class="row">
                                                                <div class="col-lg-3 col-3">
                                                                    <img style="padding-right: 10px;" class=""
                                                                         width="100%"
                                                                         src="<?= b() . "/assets/img/icon/sto.png" ?>"
                                                                         alt="">
                                                                </div>
                                                                <div class="col-lg-9 col-9">
                                                                    ...
                                                                    <p class="description" id="stockadd"><?= $uniq->adet ?> <?= ($_SESSION["lang"]==1)?"Adet":"Unit" ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="content">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-9">
                                                                    <h4 class="title "
                                                                        style="font-size:16px; margin:-3px 0">
                                                                        <?= ($_SESSION["lang"] == 1) ? "Satılan Stok" : "Selled Stock" ?></a></h4>
                                                                    <?php
                                                                    $satilan=$this->m_tr_model->query("select count(*) as say from table_orders_adverts where sell_user_id=".getActiveUsers()->id." and status=3 and is_delete=0 and advert_id=".$uniq->id);
                                                                    ?>
                                                                    <p class="description" id="stockadd"><?= (($satilan)?(($satilan[0]->say>0)?$satilan[0]->say:"-"):"-") ?> <?= ($_SESSION["lang"]==1)?"Adet":"Unit" ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <p class="description" id="komOran">
                                                                        ...
                                                                        if($user->magaza_ozel_komisyon!=0 && $user->magaza_ozel_komisyon!=""){
                                                                            if($user->magaza_ozel_komisyon!=$uniq->commission_oran){
                                                                                $farkli=1;
                                                                                echo "%". $user->magaza_ozel_komisyon." <small style='font-size:12px;' class='text-danger'>(".(($_SESSION["lang"]==1)?'Eski ':'Old ')." %".$uniq->commission_oran.")</small>";
                                                                            }else{
                                                                            ...
                                                                            if($uniq->category_top_id!=0){
                                                                                if($uniq->category_parent_id==0){
                                                                                    ...
                                                                                    if($parent){
                                                                                        if($parent->commission!=$uniq->commission_oran){
                                                                                            $farkli=1;
                                                                                            echo "%". $parent->commission." <small  style='font-size:12px;' class='text-danger'>(".(($_SESSION["lang"]==1)?'Eski ':'Old ')." %".$uniq->commission_oran.")</small>";
                                                                                        }else{
                                                                                            echo "%". $parent->commission." ";
                                                                                        }
                                                                                    }
                                                                                }else{
                                                        ...
                                                        <div class="content">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-9">
                                                                    <h4 class="title "
                                                                        style="font-size:16px; margin:-3px 0">
                                                                        <?= ($_SESSION["lang"] == 1) ? "Kazanılacak" : "To be won" ?></a></h4>
                                                                    <p class="description" id="cash">
                                                                        <?php
                                                                        $kazanilacak=$this->m_tr_model->query("select sum(cash) as say from table_adverts_stock where ads_id=".$uniq->id." and status=0 ");
                                                                        if($kazanilacak){
                                                                            if($kazanilacak[0]->say>0){
                                                                                echo number_format($kazanilacak[0]->say,2)." ".getcur();
                                                                            }else{
                                                                                echo "-";
                                                                            }
                                                                        }else{
                                                        ...
                                                        <div class="content">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-9">
                                                                    <h4 class="title "
                                                                        style="font-size:16px; margin:-3px 0">
                                                                        <?= ($_SESSION["lang"] == 1) ? "Kazanılan" : "Won" ?></a></h4>
                                                                    <p class="description" id="cash">
                                                                        <?php
                                                                        $kazanilacak=$this->m_tr_model->query("select sum(cash) as say from table_adverts_stock where ads_id=".$uniq->id." and status=1 ");
                                                                        if($kazanilacak){
                                                                            if($kazanilacak[0]->say>0){
                                                                                echo number_format($kazanilacak[0]->say,2);
                                                                            }else{
                                                                                echo "-";
                                                                            }
                                                                        }else{
                                    ...
                                    <div class="col-lg-12 mt-5 deleted">
                                        <hr>
                                        <h6 class="title" style="font-size: 14px">
                                            <i class="fa fa-arrow-right"></i> <?= ($_SESSION["lang"] == 1) ? "Varolan Stoklar" : "Existing Stocks" ?>
                                        </h6>
                                    </div>
                                    <div class="">
                                        <table class="table table-bordered table-hover dataTable" id="kt_datatable">
                                            <thead>
                                            <tr>
                                                <th data-priority="1" width="5%" class="text-center">
                                                    <?= ($_SESSION["lang"] == 1) ? "No" : "No" ?>
                                                </th>
                                                <th data-priority="2" width="20%" class="text-center">
                                                    <?= ($_SESSION["lang"] == 1) ? "Kod" : "Code" ?>
                                                </th>
                                                <th width="10%" class="text-center">
                                                    <?= ($_SESSION["lang"] == 1) ? "Durum" : "Status" ?>
                                                </th>
                                                <th width="10%" class="text-center" style="text-align: center !important;">
                                                    <?= ($_SESSION["lang"] == 1) ? "Sat." : "Sell." ?>
                                                </th>
                                                <th width="10%" class="text-center" style="text-align: center !important;">
                                                    <?= ($_SESSION["lang"] == 1) ? "Tutar" : "Amount" ?>
                                                </th>
                                                <th  width="10%" class="text-center" style="text-align: center !important;">
                                                    <?= ($_SESSION["lang"] == 1) ? "Komisyon" : "Commission" ?>
                                                </th>
                                                <th width="10%" class="text-center text-success " style="text-align: center !important;">
                                                    <?= ($_SESSION["lang"] == 1) ? "Kazanç" : "Earn" ?>
                                                </th>
                                                <th width="5%" class="text-center">
                                                    <?= ($_SESSION["lang"] == 1) ? "İşlem" : "Actions" ?>
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody id="sttt">
                                            <?php
                                            $stoklar=getTableOrder("table_adverts_stock",array("ads_id" => $uniq->id),"id","asc");
                                            if($stoklar){
                                                $say=1;
                                                foreach ($stoklar as $item) {
                                                    ...
                                                    <tr style="vertical-align: middle !important">
                                                        ...
                                                        <td><?php
                                                            if($item->status==0){
                                                                ?>
                                                                <span class="badge bg-warning text-dark badge-warning"><i class=" fa fa-clock-o"></i> <?=(($_SESSION["lang"]==1)?"Satışta":"On Sale") ?></span>
                                                                <?php
                                                            }else{
                                                                ?>
                                                                <span class="badge bg-success text-dark badge-warning"><i class=" fa fa-check"></i> <?=(($_SESSION["lang"]==1)?"Satıldı":"Selled ") ?></span>
                                                                <?php
                                                            }
                                                            ?>
                                                        </td>
                                                        <td><?php
                                                            if($item->status==0){
                                                                ...
                                                                echo date("d-m-Y H:i",strtotime($item->sell_at));
                                                            }
                                                            ?>
                                                        </td>
                                                        <td><?php
                                                            echo number_format($item->price,2)." ".getcur();
                                                            ?>
                                                        </td>
                                                        <td><?php
                                                            echo number_format($item->komisyon,2)." ".getcur();
                                                            ?>
                                                        </td>
                                                        <td><?php
                                                            echo number_format($item->cash,2)." ".getcur();
                                                            ?>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            if($item->status==0){
                                                                ?>
                                                                <a data-id="<?= rand(1000,9999) ?>S<?= rand(1,1000)."T".$item->id."T".rand(1000,9999)  ?>" onclick="modalActives('<?= $item->code ?>','<?= rand(1000,9999) ?>S<?= rand(1,1000)."T".$item->id."T".rand(1000,9999)  ?>')" data-bs-toggle='modal' data-bs-target='#placebidModal2' class="btn-block  btn text-black btn-danger btn-small"
    ...
    <div class="rn-popup-modal placebid-modal-wrapper modal fade" id="placebidModal2" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?= ($_SESSION["lang"]==1)?"Stok Sil":"Stock Delete"?></h5>
                </div>
                <div class="modal-body">
                    <div class="placebid-form-box text-center">
                        <b id="descc12" class="text-danger"></b><br>
                        <?= ($_SESSION["lang"]==1)?"Stok silnecektir. Emin misiniz":"The stock will be deleted. are you sure"  ?>
                        <div class="bit-continue-button mt-4" style="margin-top: 30px !important;">
                            <div class="row">
                                <div class="col-lg-12" id="uyCont" style="display: none">
                                    <div class="alert alert-warning"></div>
                                ...
                                <div class="col-lg-7">
                                    <button type="button" id="stokDelete" class="btn btn-primary w-100"><i class="fa fa-check"></i> <?= ($_SESSION["lang"]==1)?"Sil":"Delete" ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
