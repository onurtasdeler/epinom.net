...
if ($this->input->get("type")) {
    ...
    if ($temizle == "waiting") {
        $text = langS(232, 2);
        $getTable=getTable("table_orders_adverts",array("user_id" => getActiveUsers()->id,"types" => 1,"status" => 0 ));

    } else if ($temizle == "pending") {
        $text = langS(313, 2);
        $getTable=$this->m_tr_model->query("select * from table_orders_adverts where (status=1 or status=2 ) and user_id = ".getActiveUsers()->id."  and types = 1");
    } else if ($temizle == "completed") {
        $text = langS(233, 2);
        $getTable=$this->m_tr_model->query("select * from table_orders_adverts where status=3 and user_id = ".getActiveUsers()->id." ");
    } else if ($temizle == "cancelled") {
        $text = langS(322, 2);
        $getTable=$this->m_tr_model->query("select * from table_orders_adverts where status=4 and user_id = ".getActiveUsers()->id." ");
    } else {
        redirect(b() . gg());
    }
            ...
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-muted">
                                         <?php
                                         $ce=getTable("table_orders_adverts",array("user_id" => getActiveUsers()->id,"status" => 0,"is_delete" => 0));
                                         if($ce){
                                             if($_SESSION["lang"]==1){
        ...
        <div class="top-seller-inner-one  bg-info    explore w-100">
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-muted">
                                           <?php
                                           $ce=$this->m_tr_model->query(" select count(*) as say from table_orders_adverts where user_id=".getActiveUsers()->id." and (status=1 or status=2) and types=1 ");
                                           if($ce){
                                               if($ce[0]->say>0){
                                                   if($_SESSION["lang"]==1){
    ...
    <div class="col-lg-3 col-6 mt-2 d-flex align-items-center">
        <div class="top-seller-inner-one  bg-success    explore w-100">
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    <a href="author.html">
                        <h6 class="name text-white  " style="font-family: 'Montserrat'">Teslim Edildi</h6>
                    </a>
                    <span class="count-number text-white">
                        <?php
                        $ce=getTable("table_orders_adverts",array("user_id" => getActiveUsers()->id,"status" => 3,"is_delete" => 0));
                        if($ce){
                            if($_SESSION["lang"]==1){
                                echo "Toplam ".count($ce)." Sipariş";
                            }else{
            ...
            <div class="top-seller-wrapper ">
                ...
                <div class="top-seller-content">
                    ...
                    <span class="count-number text-white">
                                             ...
                                             <?php
                                             $ce=getTable("table_orders_adverts",array("user_id" => getActiveUsers()->id,"status" => 4,"is_delete" => 0));
                                             if($ce){
                                                 if($_SESSION["lang"]==1){
                                                     echo "Toplam ".count($ce)." Sipariş";
                                                 }else{
                    ...
                    <div class="bid-content">
                        <div class="bid-content-mid">
                            ...
                            <div class="bid-content-right">
                                ...
                                <span id="mStore"></span>
                                <span id="mPrice"></span>
                                <span id="mTeslim"></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-11 text-center mb-2 ">
                            <span class="w-100 text-center"><?= ($_SESSION["lang"] == 1) ? "İlgili Kod" : "Relevant Code" ?></span>
                        </div>
                        <div class="col-lg-11">
                            <span id="mCode" style="font-size:15px; border:1px dotted #ccc; border-radius: 10px;" class=" w-100 badge bg-outline-success"></span>
                        </div>
                        <div class="col-lg-1 ">
                            <a href="javascript:;" class="" id="copyButton" ><i class="fa fa-copy"></i></a>
                        </div>
                ...
                <div class="placebid-form-box">
                    ...
                    <form id="supportForm" method="post" onsubmit="return false">
                        ...
                        <div class="bit-continue-button mt-4" style="margin-top: 30px !important;">
                            <div class="row">
                                <div class="col-lg-12" id="uyCont3" style="display: none">
...
<div class="rn-popup-modal placebid-modal-wrapper modal fade" id="placebidModalcancel" tabindex="-1"
     aria-hidden="true">
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i data-feather="x"></i>
    </button>
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 530px">
                                ...
                                <div class="row mt-4" >
                                    ...
                                    <div class="col-lg-4 mt-3 text-start">
                                        <h5 style="font-size:18px"><?= ($_SESSION["lang"]==1)?"Yorumunuz":"Comments" ?>
                                            <br>  <small style="font-size:12px;" class="text-muted">(Max 20-100 <?= ($_SESSION["lang"]==1)?"Karakter":"Chars" ?>)</small></h5>
                                        <br>
                                    </div>
                    ...
                    <form id="commentForm" method="post" onsubmit="return false">
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                <div class="alert alert-warning">
                                    <i class="fa fa-warning"></i> <?= langS(239) ?>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="row">
