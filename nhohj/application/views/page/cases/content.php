            ...
            <?php
                ...
                <div class="col-lg-6 col-md-6 col-12 d-none d-sm-block  ">
                    <ul class="breadcrumb-list">
                        ...
                        if($sub){
                            ?>
                            <li class="item"><a href="<?= base_url(gg().$sayfa->link) ?>"><?= (lac()==1)?"Kasalar":"Cases" ?></a></li>
                            <li class="separator"><i class="feather-chevron-right"></i></li>
        ...
        <div class="row g-5 mt_dec--30">
            ...
            if($kasalar){
                foreach ($kasalar as $kasa) {
                    $ll=getLangValue($kasa->id,"epin_cases");
                    ?>
                        ...
                        <div class="product-style-one no-overlay with-placeBid" style="height: 99%">
                            <div class="card-thumbnail">
                                    ...
                                    <a href="<?= base_url(gg().$detay->link."/".$ll->link) ?>">
                                        <img src="<?= geti("product/".$kasa->image) ?>" alt="<?= $ll->name ?>">
                                    </a>
                            </div>
            ...
            <div class="comments-wrapper pt--40">
                <div class="comments-area">
                    <div class="trydo-blog-comment">
                        <h5 class="comment-title mb--40"><?= $sayfa->kisa_aciklama ?></h5>
                        <!-- Start Coment List  -->
