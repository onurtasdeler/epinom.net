                ...
                if(types==1){
                    ...
                    if(response.veri!="nothing"){
                       ...
                       // //toastr.warning("Kayıt Yok");
                        $("#loadResultDop").html("<div class='col-lg-12'><div class='alert alert-info'>Aramanıza uygun ilan bulunamadı</div></div>")
                        $("#loadMoreDop").hide();
                        var body = $("html, body");
                        body.stop().animate({scrollTop:200}, 400, 'swing', function() {});
                    }
                    ...
                    if(response.veri!="nothing"){
                        ...
                        ////toastr.warning("Kayıt Yok");
                        $("#loadResultNor").html("<div class='col-lg-12'><div class='alert alert-info'>Aramanıza uygun ilan bulunamadı</div></div>")
                        $("#loadMoreNormal").hide();
                        var body = $("html, body");
                        body.stop().animate({scrollTop:200}, 400, 'swing', function() {});
                    }
