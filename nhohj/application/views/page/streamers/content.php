...
<div class="rn-breadcrumb-inner ptb--30 css-selector">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            $yayinciBasvuru = getLangValue(122,"table_pages");
            ...
            if (getActiveUsers()) {
                ...
                <div class="author-button-area  mt-4 d-flex align-items-center justify-content-end   " style="margin: 0; padding:0">
                    ...
                    <a  href="<?= base_url(gg().$yayinciBasvuru->link) ?>" class="btn at-follw brebutton  share-button" >
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="item"><a href="<?= base_url(gg().$sayfa->link) ?>"><?= (lac()==1)?"Yayincilar":"Streamers" ?></a></li>
        ...
        <div class="row g-5 mt_dec--30">
            ...
            if($yayincilar){
                ...
                foreach ($yayincilar as $yayinci) {
					...
					if (!strpos($yayinci->image, 'https')){
						$image = $yayinci->image;
					}else{
						$image = geti("avatar/".$yayinci->image);
					}
					
					//!strpos($yayinci->image,"https")?$item->image:geti("avatar/".$yayinci->image);
                    ...
                    <div class="col-6 col-lg-2 col-md-2 col-sm-6 " >
                        ...
                        <div class="product-style-one no-overlay with-placeBid" style="height: 99%">
                            ...
                            <div class="card-thumbnail mb-3">
                                ...
                                <a href="<?= base_url(gg().$sayfa->link."/".$yayinci->username) ?>">

                                    <img src="<?= $image; ?>" alt="<?= $yayinci->username ?>">
                            ...
                            <a href="<?= base_url(gg().$sayfa->link."/".$yayinci->username) ?>">
                                ...
                                <span class="mt-3 product-name text-center"><?= $yayinci->username ?></span>
