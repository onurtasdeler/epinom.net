        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <ul class="breadcrumb-list">
					...
					if($product->categorty_main_id!=0){
                    ...
                    <li class="item"><a
                            ...
                            href="<?= base_url(gg() . $detay->link."/".getLangValue($product->category_main_id,"table_products_category")->link) ?>"><?= (lac() == 1) ? "Tüm Oyunlar" : "All Games" ?></a>
    ...
    padding-bottom: 37px;">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        if ($product->is_stock == 1) {
                                                                                            ...
                                                                                            if (get_product_stock($product->id) && get_product_stock($product->id) > 0) {
                                                                                                    ...
                                                                                                    <div class="quantity-field-container">
                                                                                                        ...
                                                                                                        <div class="quantity-field">
                                                                                                            ...
                                                                                                            <div class="quantity-field-input">
                                                                                                                ...
                                                                                                                <button type="button" class="decrease-btn" data-id="<?= $product->pro_token?>">-</button>

                                                                                                                <input name="quantity" class="quantity" step="1" min="1" max="10" type="text" maxlength="8" autocomplete="off" readonly value="1" data-id="<?= $product->pro_token?>">

                                                                                                                <button type="button" class="increase-btn" data-id="<?= $product->pro_token?>">+</button>
                                                                                                ...
                                                                                                <div class="col-lg-4">
                                                                                                    ...
                                                                                                    <a href="javascipt:;"  data-bs-toggle='modal'

                                                                                                       data-hash="<?= $product->pro_token ?>"

                                                                                                       data-bs-target='#placebidModal-<?= $product->pro_token ?>' class="btn-grad  btnBaskets">

                                                                                                        <i class="fa fa-shopping-basket"></i> <?= ($_SESSION["lang"]==2)?"Sepete Ekle":"Add Basket"  ?>
                                                                                                ...
                                                                                                <div class="col-lg-4">
                                                                                                    ...
                                                                                                    <a href="javascipt:;"  data-bs-toggle='modal'
                                                                                                       ...
                                                                                                       data-bs-target='#placebidModal-<?= $product->pro_token ?>' class="btn-grad  btnBaskets">
                                                                                                        ...
                                                                                                        <i class="fa fa-shopping-basket"></i> <?= ($_SESSION["lang"]==1)?"Sepete Ekle":"Add Basket"  ?>
            ...
            <div class="modal-content" style="<?= ($goster==3 || $goster==4)?"    max-height: 379px;":"" ?>">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i
                        ...
                        - <?= getLangValue($product->id,"table_products")->name ?></h5>
