                                                ...
                                                <div class="single-activity-wrapper  mb-3 mt-3">
                                                    <div class="inner" style="display: flex">
                                                        ...
                                                        <div class="price-area fty d-flex align-items-center"
                                                             style="flex-basis:60%;justify-content:end">
                                                            ...
                                                            <?php if($urun->alis_stok>0): ?>
                                                            <a id="" class="btn mt-4 btnBasket"
                                                               data-bs-toggle='modal'
                                                               data-hash="<?= $urun->pro_token ?>"
                                                               data-bs-target='#placebidModal-<?= $urun->pro_token ?>_alis'>
                                                                <i class="fa fa-shopping-basket"
                                                                   style="padding-right: 10px"></i> <?= (lac() == 1) ? custom_number_format($urun->price)." ".getcur()." Bize Sat" : "Sell To Us From " . custom_number_format($urun->price) ." ".getcur() ?></a>
                                                            <?php endif; ?>
                                                            <?php if($urun->stok>0): ?>
                                                            <a id="" class="btn mt-4  btnBasket"
                                                               data-bs-toggle='modal'
                            ...
                            <div class="tab-pane fade" id="content3">
                                <div class="row">
                                    ...
                                    $yorumlar=$this->m_tr_model->query("select av.image as avi, p.id as urun_id,us.nick_name as user_name,s.puan,s.comment as cc,s.created_at as ft from table_comments as s 
                                                                            ...
                                                                            left join table_products_category as c on p.category_id=c.id where s.status=2 and s.is_yayin=1 and c.id=".$subsub->id);
                                    if($yorumlar){
                                                ...
                                                <div class="single-activity-wrapper  mb-3 mt-3">
                                                    <div class="inner" style="display: flex">
                                                        ...
                                                        <div class="price-area  fgb d-flex align-items-center" style="flex-direction: row">
                                                            <span><?= date("d-m-Y H:i",strtotime($yorum->ft)) ?></span>
                                                            <br>
                                                            <?php
