...

{
    ...
    function Index()
    {
        $this->load->view("pages/incomes/list");
        return;
    }
    ...
    function edit($incomeID)
    {
        ...
        $this->load->view("pages/incomes/edit", (object)$viewData);
    }
    function showOutgoings()
    {
        ...
        foreach ($outgoings as $rows) {
            ...
            $outgoingPrice = '<span class="text-success">+ ' . $rows->price . " AZN</span>";

            $editLink = base_url("incomes/edit/" . $rows->id);
            $deleteLink = base_url("incomes/edit/" . $rows->id . "?delete");
    ...
    function Add()
    {
        ...
        $this->load->view("pages/incomes/add", (object)$viewData);
        return;
    }
}
