                    ...
                    <div id="news">
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header"><strong>Sayfa Bilgileri</strong></h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold small">Başlık</label>
                                                    <input type="text" class="form-control form-control-lg" name="page_name" placeholder="Başlık" value="<?=set_value("page_name")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
