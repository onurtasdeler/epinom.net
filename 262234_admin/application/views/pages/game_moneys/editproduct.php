                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Oyun Parası Ürünü: <?=$product->title?></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="stock_qty" placeholder="Stok Adeti" value="<?=$product->stock_qty?>">
                                                <?php
                                                    if(isset($form_error)){
                                                ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" class="form-control" name="selltous_price" placeholder="Bize Sat Fiyatı" value="<?=$product->selltous_price?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="provisions" placeholder="Karşılığı" value="<?=$product->provisions?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="information" placeholder="Bilgilendirme" value="<?=$product->information?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rank" placeholder="Sıralama" value="<?=$product->rank?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                        <option <?=$product->category_id == $cat->id ? 'selected' : null?> value="<?=$cat->id?>"><?=$cat->title?></option>
                                                    <?php
                                                        endforeach;
                                                    ?>
                                                    </select>
