                                        ...
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <?php
                                                        echo orderStatus($order->status, "badge");
                                                    ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="<?=base_url("gamemoneys/order/" . $order->id)?>" class="btn btn-outline-primary btn-sm">
