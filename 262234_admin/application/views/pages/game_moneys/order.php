                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">
                                    Sipariş - <?=date("d/m/Y H:i", strtotime($order->created_at))?>
                                </h2>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">
                                        <span class="d-flex">
                                            <span><strong>Sipariş Bilgileri</strong></span>
                                            <div class="dropdown ml-auto">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" x-placement="bottom-end" style="position: absolute; transform: translate3d(18px, 23px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                    <a class="dropdown-item" href="<?=base_url("gamemoneys/order/" . $order->id . "?process=y&update_status=0")?>">"Beklemede" durumuna al</a>
                                                    <a class="dropdown-item" href="<?=base_url("gamemoneys/order/" . $order->id . "?process=y&update_status=1")?>">"Karakter Oyuna Giriyor" durumuna al</a>
                                                    <a class="dropdown-item" href="<?=base_url("gamemoneys/order/" . $order->id . "?process=y&update_status=2")?>">"Teslim Edildi" durumuna al</a>
                                                    <a class="dropdown-item" href="<?=base_url("gamemoneys/order/" . $order->id . "?process=y&update_status=3")?>">"İptal Edildi" durumuna al</a>
                                                </div>
                                            </div>
                                        </span>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <strong>Sipariş Durumu: </strong> <?=orderStatusGameMoneys($order->status)?>
                                            </div>
                                            <div class="col-6">
