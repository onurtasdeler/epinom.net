                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header d-flex align-center justify-content-center">
                                        ...
                                        <a href="<?=base_url("gamemoneys/insertcategory")?>" class="btn btn-primary btn-sm ml-auto">
                                    ...
                                    ?>
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            <thead>
                                                <tr>
                                                <th colspan="2" scope="col" width="60%">Kategori Adı</th>
                                            ...
                                            ?>
                                                <tr>
                                                    <td width="5">
                                                        <img src="<?=orj_site_url("public/categories/" . $category->image_url)?>" class="img-fluid rounded border-primary" style="border: 2px solid">
                                                    </td>
                                                    <th scope="row">
                                                        <strong><?=$category->title?></strong><br>
                                                        <a href="<?=base_url('gamemoneys/products/' . $category->id)?>">Ürünleri Listele</a>
                                                    </th>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="<?=base_url("gamemoneys/editcategory/" . $category->id)?>" class="btn btn-primary btn-sm">
                                                                <i class="fas fa-edit"></i> Düzenle
                                                            </a>
                                                            <a href="<?=base_url("categories/editcategory/" . $category->id . "?delete")?>" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal<?=$category->id?>">
                                                                ...
                                                                <div class="modal-dialog modal-sm" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="<?=base_url("gamemoneys/editcategory/" . $category->id . "?delete")?>" class="btn btn-danger">Sil</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    ?>
                                    <div class="alert alert-info mb-0">Hiç kategori bulunmuyor.</div>
                                    <?php
                                        }
                                    ?>
                                    </div>
