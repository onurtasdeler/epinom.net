                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header d-flex align-center justify-content-center">
                                        ...
                                        <a href="<?=base_url("gamemoneys/insertproduct/" . $category->id)?>" class="btn btn-primary btn-sm ml-auto">
                                        ...
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="<?=base_url("gamemoneys/editproduct/" . $product->id)?>" class="btn btn-primary btn-sm">
                                                                <i class="fas fa-edit"></i> Düzenle
                                                            </a>
                                                            <a href="<?=base_url("categories/editproduct/" . $product->id . "?delete")?>" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal<?=$product->id?>">
                                                                ...
                                                                <div class="modal-dialog modal-sm" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="<?=base_url("gamemoneys/editproduct/" . $product->id . "?delete")?>" class="btn btn-danger">Sil</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    ?>
                                    <div class="alert alert-info mb-0">Hiç ürün bulunmuyor.</div>
                                    <?php
                                        }
                                    ?>
                                    </div>
