            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div id="settings">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header font-weight-bold">Destek Talepleri</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    if(count($desks)>0){
                                        ...
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            <thead>
                                            <tr>
                                                <th scope="col" width="10%">Destek No</th>
                                                <th scope="col">Üye</th>
                                            ...
                                            foreach($desks as $desk):
                                                $user = $this->db->query("SELECT * FROM users WHERE id = '" . $desk->user_id . "'")->result()[0];
                                                ?>
                                                <tr>
                                                    <th scope="row"><?=$desk->help_code?></th>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <?php
                                                            if($desk->is_active && $desk->is_cancel == 0){
                                                        ?>
                                                                <div class="badge badge-success">Açık</div>
                                                        <?php
                                                            }else{
                                                        ?>
                                                    ...
                                                    <td>
                                                        <?=date("d.m.Y H:i", strtotime($desk->created_at))?>
                                                    </td>
                                                    <td>
                                                        <a href="<?=base_url("helpdesk/view/" . $desk->id)?>" class="btn btn-outline-primary btn-sm">
