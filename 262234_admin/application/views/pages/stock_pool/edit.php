                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header d-flex align-center justify-content-start">
                                    <span class="font-weight-bold">Stok Düzenle</span>
                                </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                            <option <?=$stockItem->product_id == $_p->id ? 'selected' : NULL?> value="<?=$_p->id?>"><?=$_p->product_name?></option>
                                    <?php
                                        endforeach;
                                    ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label class="small font-weight-bold">İlgili Alan (E-PIN kodu vb.)</label>
                                        <textarea name="codeArea" rows="4" class="form-control" required><?=$stockItem->code?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="small font-weight-bold">Satıldı mı?</label>
                                        <select name="soldStatus" class="form-control">
                                            <option value="1" <?=$stockItem->is_sold == 1 ? 'selected' : null?>>Satıldı</option>
                                            <option value="0" <?=$stockItem->is_sold == 0 ? 'selected' : null?>>Aktif</option>
                                        </select>
                                    </div>
                                <?php
                                    if($stockItem->user_id != null){
                                ?>
                                    <div class="form-group">
                                        <label class="small font-weight-bold">Satıldığı Üye</label>
                                        <input type="text" class="form-control" disabled value="<?=$this->db->where('id=' . $stockItem->user_id)->get('users')->row()->email?>">
                                    </div>
                                <?php
                                    }
                                ?>
