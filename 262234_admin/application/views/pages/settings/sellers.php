                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Satıcı Entegrasyonları</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Satıcı Entegrasyonları</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header d-flex align-center">
                                    <span class="font-weight-bold">Satıcı Entegrasyonları</span>
                                </h5>
                                    ...
                                    if(count($sellers)>0){
                                        foreach($sellers as $p):
                                            ...
                                            <div class="p-3 border shadow-sm d-flex align-items-center mb-2">
                                                <div>
                                                    <img src="<?=orj_site_url('public/seller_integrations/' . $p->image_url)?>" width="100" alt="<?=$p->method_name?>" class="border-right pr-2 mr-2">
                                                    <strong><?=$p->method_name?></strong>
                                                </div>
                                                <div class="ml-auto">
                                                    <button data-toggle="modal" data-target="#sellerMethodModal<?=$p->id?>" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-cog"></i> Ayarlar
                                                    </button>
                                                    <div class="modal fade" id="sellerMethodModal<?=$p->id?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                            ...
                                                            <div class="modal-content rounded-0">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(!isset($_GET['update_modal_ok'])):
                                                                    ?>
                                                                        <p>Lütfen epin sağlayıcısı tarafından size verilen bilgileri aşağıdaki alana giriniz.</p>
                                                                        <?=form_open('settings/seller/' . $p->id . '?modal', [
                                                                            'id' => 'sellerMethodForm' . $p->id
                                                                        ])?>
                                                                            <input type="hidden" name="editSellerMethod" value="true">
                                                                            <?php
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="#" onclick="document.getElementById('sellerMethodForm<?=$p->id?>').submit()" class="btn btn-primary font-weight-bold">Bilgileri Kaydet</a>
                                                                </div>
                                                                <?php
                                                                    endif;
                                                                ?>
                                        ...
                                        ?>
                                        <div class="alert alert-info mb-0">Hiç satıcı entegrasyonu eklenmemiş.</div>
                                        <?php
                                    }
                                    ?>
                                </div>
