            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tema Ayarları</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Tema Ayarları</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div id="settings">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header font-weight-bold">Tema Ayarları</h5>
                                <div class="card-body">
                                    <?=form_open_multipart("settings/theme")?>
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                <label class="font-weight-bold small">Logo Görseli</label>
                                                <input type="file" class="form-control" placeholder="Logo Görseli" name="logo">
                                                <?php
                                                if(isset($form_error)){
                                                    ?>
                                                    <div class="text-danger small"><?php echo form_error("logo"); ?></div>
                                                    <?php
                                                }
                                                ?>
                                            </div>
                                            <div class="col-lg-6">
                                                <img src="<?=!empty($config->logo_image_url) ? orj_site_url('public/theme/' . $config->logo_image_url) : orj_site_url('assets/dist/images/logo.png')?>" alt="Mevcut Logo" width="250">
                                            </div>
                                        </div>
                                        <hr>
                                        <button type="submit" class="btn btn-primary" name="submitThemeSettings" value="ok">Bilgileri Güncelle</button>
                                    <?=form_close()?>
                                </div>
                            </div>
                        </div>
