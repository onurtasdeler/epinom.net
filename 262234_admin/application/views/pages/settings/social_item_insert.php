                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Sosyal Medya Ekle</h2>
                    ...
                    <div id="settings">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header"><strong>Sosyal Medya Hesabı Ekle</strong></h5>
                                    <div class="card-body">
                                        <?=form_open("social/new")?>
                                            <div class="form-group">
                                                <label class="font-weight-bold small">İsim</label>
                                                <input type="text" class="form-control" name="name" placeholder="İsim" value="<?=set_value("name")?>">
                                                <?php
                                                    if(isset($form_error)){
                                                ?>
                                            ...
                                            <hr>
                                            <button type="submit" class="btn btn-primary" name="submitForm" value="ok">Ekle</button>
                                        <?=form_close()?>
                                    </div>
                                </div>
                            </div>
