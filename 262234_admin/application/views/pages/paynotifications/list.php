                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div id="settings">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header font-weight-bold">Ödeme Bildirimleri</h5>
                                    ...
                                    ?>
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            ...
                                            <?php
                                                foreach($rows as $row):
                                                    $user = $this->db->query("SELECT * FROM users WHERE id = '" . $row->user_id . "'")->result()[0];
                                            ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <?php
                                                                if($row->status != 1){
                                                            ?>
                                                            <a href="<?=base_url("paynotifications/process/" . $row->id . "?accept")?>" class="btn btn-success btn-sm">
                                                            ...
                                                            <?php
                                                                if($row->status != 2){
                                                            ?>
                                                            <a onclick="return confirm('İptal etmek istediğinize emin misiniz? Bakiye daha önceden verildiyse geri alınacak.')" href="<?=base_url("paynotifications/process/" . $row->id . "?decline")?>" class="btn btn-danger btn-sm">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Ödeme Bildirimi Bilgileri</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <strong>Gönderen Adı Soyadı: </strong> <span><?=$payInformation->senderFullName?></span>
                                                            <hr>
                                                            <strong>Gönderim Tarihi: </strong> <span><?=date("d/m/Y", strtotime($payInformation->sendTime))?></span>
                                                            <hr>
                                                            <strong>Gönderilen Hesap IBAN: </strong> <span><?=$payInformation->bankAccountIBAN?></span>
                                                            <hr>
                                                            <strong>Tutar: </strong> <span><?=$payInformation->price?></span>
                                                            <hr>
                                                            <strong>Açıklama: </strong><br> <span><?=$payInformation->description?></span>
                                                            <hr>
                                                            <small>
                                                                <small>
                                                                    <strong>Hash: </strong><span><?=$payInformation->sendPaymentInformation?></span>
                                                                </small>
                                                            </small>
                                                        </div>
                                    ...
                                    ?>
                                    <div class="alert alert-info mb-0">Hiç ödeme bildirimi bulunmuyor.</div>
                                    <?php
                                        }
                                    ?>
                                    </div>
