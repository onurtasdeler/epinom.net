        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Slide Ekleme</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Slide Ekle</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("slider/add")?>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title" placeholder="Başlık" value="<?=set_value('title')?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_active" class="form-control">
                                                        <option value="1" <?=set_value('is_active') == 1 ? 'selected' : null?>>Aktif</option>
                                                        <option value="0" <?=set_value('is_active') == 0 ? 'selected' : null?>>Deaktif</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label class="font-weight-bold small">Sıralama</label>
                                                    <input type="number" min="0" step="1" class="form-control" name="rank" placeholder="Sıralama" value="<?=set_value('rank') ? set_value('rank') : 0?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="slide_area" class="form-control">
                                                        <option value="0" <?=set_value('slide_area') == 0 ? 'selected' : null?>>Normal (Anasayfa)</option>
                                                        <option value="1" <?=set_value('slide_area') == 1 ? 'selected' : null?>>Sağ Üst (Anasayfa)</option>
                                                        <option value="2" <?=set_value('slide_area') == 2 ? 'selected' : null?>>Sağ Alt (Anasayfa)</option>
                                                    </select>
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
