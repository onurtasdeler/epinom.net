        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Duyuru: <?=$item->id?></h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?=base_url()?>" class="breadcrumb-link">Control Panel</a></li>
                                            <li class="breadcrumb-item"><a href="<?=base_url("announcements")?>" class="breadcrumb-link">Slider</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Duyuru: <?=$item->id?></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("announcements/edit/" . $item->id)?>
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header"><strong>Duyuru Bilgileri</strong></h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold small">İçerik</label>
                                                    <input type="text" class="form-control" name="content" placeholder="İçerik" value="<?=$item->content?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                        <div class="text-danger small"><?php echo form_error("content"); ?></div>
                                                    <?php
                                                        }
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="a_link" placeholder="Link" value="<?=$item->a_link?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                        <div class="text-danger small"><?php echo form_error("a_link"); ?></div>
                                                    <?php
                                                        }
                                                    ?>
                                                </div>
                                                ...
                                                <a class="btn btn-light" href="<?=base_url("announcements/list")?>">
                                                    Duyuru Listesi
                                                </a>
                                            </div>
                                        </div>
