                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header d-flex align-center justify-content-start">
                                    ...
                                    <a href="<?=base_url("announcements/add")?>" class="btn btn-primary btn-sm ml-auto">
                                ...
                                <div class="card-body">
                                    ...
                                    if(count($announcements)>0){
                                        ...
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            <thead>
                                            <tr>
                                                <th scope="col" width="50%">İçerik</th>
                                            ...
                                            <tbody>
                                            <?php
                                            foreach($announcements as $_anc):
                                                ?>
                                                <tr>
                                                    <th scope="row"><?=$_anc->content?></th>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?=base_url("announcements/edit/" . $_anc->id)?>" class="btn btn-primary btn-sm">
                                                            <i class="fas fa-pencil-alt"></i> Düzenle
                                                        </a>
                                                        <a href="<?=base_url("announcements/delete/" . $_anc->id)?>" class="btn btn-danger btn-sm">
                                        ...
                                        ?>
                                        <div class="alert alert-info mb-0">Hiç kayıtlı duyuru bulunmuyor.</div>
                                        <?php
                                    }
                                    ?>
                                </div>
