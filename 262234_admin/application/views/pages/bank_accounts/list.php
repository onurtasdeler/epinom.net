                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header d-flex align-center justify-content-start">
                                    <span class="font-weight-bold">Banka Hesapları</span>
                                    <a href="<?=base_url("bankaccounts/add")?>" class="btn btn-primary btn-sm ml-auto">
                                    ...
                                    if(count($bank_accounts)>0){
                                        ...
                                        <table class="table table-bordered table-striped" id="dataTables">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" width="50%">İsimlendirme</th>
                                            ...
                                            foreach($bank_accounts as $item):
                                                ...
                                                <tr>
                                                    <td width="15%">
                                                        <img src="<?=orj_site_url('public/bank_accounts/' . $item->image_url)?>" class="w-100">
                                                    </td>
                                                    <th scope="row"><?=$item->name?></th>
                                                    <td class="text-center">
                                                        <a href="<?=base_url("bankaccounts/edit/" . $item->id)?>" class="btn btn-primary btn-sm">
                                                            <i class="fas fa-pencil-alt"></i> Düzenle
                                                        </a>
                                                        <a href="<?=base_url("bankaccounts/delete/" . $item->id)?>" class="btn btn-danger btn-sm">
                                        ...
                                        ?>
                                        <div class="alert alert-info mb-0">Hiç kayıtlı banka bulunmuyor.</div>
                                        <?php
                                    }
                                    ?>
                                </div>
