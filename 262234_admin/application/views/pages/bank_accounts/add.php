        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Banner Ekleme</h2>
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("bankaccounts/add")?>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" placeholder="İsimlendirme" value="<?=set_value('name')?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="iban" placeholder="IBAN" value="<?=set_value('iban')?>">
                                                <?php
                                                    if(isset($form_error)){
                                                ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="text" rows="5" class="form-control"><?=set_value('text')?></textarea>
