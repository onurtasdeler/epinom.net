                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header d-flex align-center justify-content-center">
                                        <span class="font-weight-bold">Haberler</span>
                                        <a href="<?=base_url("news/insert")?>" class="btn btn-primary btn-sm ml-auto">
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped" id="dataTables">
                                                <thead>
                                                    <tr>
                                                    <th colspan="2" scope="col" width="60%">Başlık</th>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td width="50">
                                                            <img src="<?=orj_site_url("public/news/" . $item->image_url)?>" class="img-fluid rounded border-primary" style="border: 2px solid">
                                                        </td>
                                                        <th scope="row">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group">
                                                                <a href="<?=base_url("news/edit/" . $item->id)?>" class="btn btn-primary btn-sm">
                                                                    <i class="fas fa-edit"></i> Düzenle
                                                                </a>
                                                                <a href="<?=base_url("news/edit/" . $item->id . "?delete")?>" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal<?=$item->id?>">
                                                                    ...
                                                                    <div class="modal-dialog modal-sm" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <a href="<?=base_url("news/edit/" . $item->id . "?delete")?>" class="btn btn-danger">Sil</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    ?>
                                    <div class="alert alert-info mb-0">Hiç kayıtlı haber bulunmuyor.</div>
                                    <?php
                                        }
                                    ?>
                                    </div>
