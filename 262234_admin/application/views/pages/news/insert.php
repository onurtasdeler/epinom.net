        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("news/insert")?>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" name="title" placeholder="Başlık" value="<?=set_value("title")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    <textarea name="text" class="form-control" rows="10"><?=set_value("text")?></textarea>
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
