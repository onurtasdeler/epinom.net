        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Haberler</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?=base_url()?>" class="breadcrumb-link">EPİNDENİZİ</a></li>
                                            <li class="breadcrumb-item"><a href="<?=base_url("news")?>" class="breadcrumb-link">Haberler</a></li>
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("news/edit/" . $item->id)?>
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header"><strong>Haber Bilgileri</strong></h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold small">Başlık</label>
                                                    <input type="text" class="form-control form-control-lg" name="title" placeholder="Başlık" value="<?=$item->title?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    <textarea name="text" class="form-control" rows="10"><?=$item->text?></textarea>
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteOnline" name="status" <?=$item->is_active == 1 ? 'checked' : null?> value="1" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteOnline">Yayında</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteClosed" name="status" <?=$item->is_active == 0 ? 'checked' : null?> value="0" class="custom-control-input">
                                                ...
                                                ?>
                                                    <small><strong>Güncellenme Tarihi:</strong> <em><?=date("d.m.Y H:i", strtotime($item->updated_at))?></em></small>
                                                <?php
                                                    }
                                                ?>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="<?=orj_site_url("public/news/" . $item->image_url)?>" width="100%" class="rounded mb-2" id="postImage">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" rows="5" name="page_title" placeholder="Sayfa Başlığı" value="<?=$item->page_title?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="5" name="meta_description" placeholder="META Açıklama"><?=$item->meta_description?></textarea>
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="meta_keywords" placeholder="META Anahtar Kelimeler"><?=$item->meta_keywords?></textarea>
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-right">
                                        <a class="btn btn-light" href="<?=base_url("news/list")?>">
                                            Haber Listesi
                                        </a>
