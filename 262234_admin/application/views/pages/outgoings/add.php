                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?= base_url('outgoings') ?>" class="breadcrumb-link">Giderler</a></li>
                            ...
                            <div class="col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header d-flex align-center justify-content-start">
                                        <span class="font-weight-bold">Gider Ekle</span>
                                    </h5>

                                    <div class="card-body">
                                        <?= form_open('outgoings/add', [
                                            'id' => 'outgoingsForm'
                                        ]) ?>
                                        <div class="form-group">
                                            <label class="small font-weight-bold">Gelir/Gider Adı</label>
                                            <input type="text" class="form-control" autocomplete="off" name="name" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="small font-weight-bold">Tarih</label>
                                            <input id="date" type="text" class="form-control" autocomplete="off" name="date" required>
                                        </div>
                                        <div class="form-group">
