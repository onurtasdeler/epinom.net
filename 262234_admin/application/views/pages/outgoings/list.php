                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header d-flex align-center justify-content-center">
                                        <span class="font-weight-bold">Gider Listesi</span>
                                        <span class="ml-auto d-flex">
                                            <input style="color:black" type="text" id="date" class="btn btn-primary form-control form-control-sm" readonly="yes">
                                            <a href="<?= base_url("outgoings/add") ?>" class="btn btn-primary form-control-sm ml-1">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-striped" id="datatable">
                                            <thead>
                                                <tr>
                                                    <th scope="col" width="30%">Gider Adı</th>
                                                    <th scope="col" width="30%">Gider Tarihi</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th>
                                                        Toplam Gider : <span class="text-danger" id="totalOutgoingPrice">0TL</span>
                                                    </th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
    ...
    <script>
        ...
        $(document).ready(function(e) {
            ...
            var table = $('#datatable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: base_url + 'outgoings/showOutgoings',
                    type: 'POST',
