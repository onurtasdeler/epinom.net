                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">
                                <?=$user->email?> Bayi Kategori Ekleme
                            </h2>
                ...
                <div id="stock">
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <?=form_open('dealers/category/insert/' . $user->id, [
                                        'id' => 'form'
                                    ])?>
                                        <div class="form-group">
                                            ...
                                            <?php
                                                foreach($this->db->get('categories')->result() as $_category){
                                            ?>
                                        ...
                                        <div class="form-group mb-0">
                                            <button type="submit" class="btn btn-primary" name="submitForm" value="ok">Ekle ve Devam Et</button>
                                        </div>
                                    <?=form_close()?>
                                </div>
                            </div>
