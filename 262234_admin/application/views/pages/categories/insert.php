        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("categories/insert")?>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="category_name" placeholder="Kategori Adı" value="<?=set_value("category_name")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="howtouse" rows="7" class="form-control"><?=set_value('howtouse')?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="up_category_id" class="form-control">
                                                        <option value="0" <?=set_value('up_category_id') == 0 ? 'selected' : NULL?>>-- YOK --</option>
                                                    <?php
                                                        foreach($this->db->get('categories')->result() as $_c):
                                                    ?>
                                                        <option value="<?=$_c->id?>" <?=set_value('up_category_id') == $_c->id ? 'selected' : NULL?>><?=$_c->category_name?></option>
                                                    <?php
                                                        endforeach;
                                                    ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="redirect" placeholder="Yönlendirme" value="<?=set_value("redirect")?>">
                                                <?php
                                                    if(isset($form_error)){
                                                ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteOnline2" name="is_new" value="1" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteOnline2">Evet</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteClosed2" name="is_new" checked value="0" class="custom-control-input">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteOnline3" name="is_popular" value="1" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteOnline3">Evet</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteClosed3" name="is_popular" checked value="0" class="custom-control-input">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteOnline4" name="is_homepage" value="1" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteOnline4">Evet</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteClosed3" name="is_homepage" checked value="0" class="custom-control-input">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="homepage_text" value="<?= set_value("homepage_text"); ?>">
                                                    <?php
                                                    if(isset($form_error)){
                                                        ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <input type="number" step="1" class="form-control" value="<?=set_value('popular_rank') ? set_value('popular_rank') : 0?>" name="popular_rank">
                                                        <?php
                                                        if(isset($form_error)){
                                                            ?>
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <input type="number" step="1" class="form-control" value="<?=set_value('normal_rank') ? set_value('normal_rank') : 0?>" name="normal_rank">
                                                        <?php
                                                        if(isset($form_error)){
                                                            ?>
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <input type="number" step="1" class="form-control" value="<?=set_value('homepage_rank') ? set_value('homepage_rank') : 0?>" name="homepage_rank">
                                                        <?php
                                                        if(isset($form_error)){
                                                            ?>
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <input type="number" step="1" min="0" name="subcat_rank" class="form-control" value="<?=set_value('subcat_rank') ? set_value('subcat_rank') : 1?>">
                                                        <?php
                                                        if(isset($form_error)){
                                                            ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteOnline4" name="is_menu" value="1" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteOnline4">Evet</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteClosed4" name="is_menu" checked value="0" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteClosed4">Hayır</label>
                                                    </div>
                                                    <br>
                                                    <?php
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img style="display:none" width="100%" class="rounded mb-2" id="postImage2">
