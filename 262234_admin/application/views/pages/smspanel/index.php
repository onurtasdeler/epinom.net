                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header d-flex align-center justify-content-start">
                                    <span class="font-weight-bold">SMS Gönder</span>
                                </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="small font-weight-bold">Üye</label>
                                        <select name="user" class="form-control select2">
                                            <option <?=set_value('user') == 0 ? 'selected' : NULL?> value="0">Tümüne Gönder</option>
                                            <?php
                                            foreach($users as $_u):
                                                ?>
                                                <option <?=set_value('user') == $_u->id ? 'selected' : NULL?> value="<?=$_u->id?>"><?=$_u->email?></option>
                                            <?php
                                            endforeach;
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label class="small font-weight-bold">Mesaj Metni</label>
                                        <textarea name="message" rows="4" maxlength="1000" class="form-control" required><?=set_value('message')?></textarea>
                                    </div>
                                    <div class="text-right">
                                        <button type="submit" class="btn btn-primary" name="submitForm" value="ok">Gönder</button>
                                    </div>
                                    <?=form_close()?>

                                    <a href="<?=current_url() . '?export_phone_numbers'?>" class="btn btn-dark px-5">Numaraları İndir</a>
                                </div>
                            </div>
                        </div>
                    </div>
