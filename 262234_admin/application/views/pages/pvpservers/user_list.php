                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header d-flex align-center justify-content-between">
                                    ...
                                    <div>
                                        <a href="<?=base_url("pvpservers")?>" class="btn btn-primary btn-sm ml-auto">
                                            Tüm Sunucular
                                        </a>
                                    </div>
                                </h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php
                                                            if($item->is_active == 0) {
                                                        ?>
                                                            <a href="<?=base_url("pvpservers/edit/" . $item->id . "?is_active=1")?>" class="btn btn-success btn-sm">
                                                                Aktif Et
                                                            </a>
                                                        <?php
                                                            } else {
                                                        ?>
                                                            <a href="<?=base_url("pvpservers/edit/" . $item->id . "?is_active=1")?>" class="btn btn-danger btn-sm">
                                                                Deaktif Et
                                                            </a>
                                                        <?php
                                                            }
