        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Server Ekle</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    ?>
                    <div id="news">
                        <?=form_open_multipart("pvpservers/insert")?>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" name="name" placeholder="İsim" value="<?=set_value("name")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteOnline" name="status" checked value="1" class="custom-control-input">
                                                        <label class="custom-control-label" for="websiteOnline">Yayında</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="websiteClosed" name="status" value="0" class="custom-control-input">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="security" placeholder="Güvenlik" value="<?=set_value("security")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="beta_date" placeholder="Beta Tarihi" value="<?=set_value("beta_date")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="official_date" placeholder="Official Tarihi" value="<?=set_value("official_date")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="game_type" placeholder="Oyun Tipi" value="<?=set_value("game_type")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="lang" placeholder="Dil" value="<?=set_value("lang")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="platform" placeholder="Platform" value="<?=set_value("platform")?>">
                                                    <?php
                                                        if(isset($form_error)){
                                                    ?>
