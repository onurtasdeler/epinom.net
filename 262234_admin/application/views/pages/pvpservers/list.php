                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header d-flex align-center justify-content-between">
                                        <span class="font-weight-bold">Pvp Serverlar</span>
                                        <div>
                                            <a href="<?=base_url("pvpservers/advertising")?>" class="btn btn-primary btn-sm ml-auto">
                                                Reklam Alanları
                                            </a>
                                            <a href="<?=base_url("pvpservers/waitingservers")?>" class="btn btn-primary btn-sm ml-auto">
                                                Kullanıcı Sunucuları
                                            </a>
                                            <a href="<?=base_url("pvpservers/insert")?>" class="btn btn-primary btn-sm ml-auto">
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        <div class="badge badge-light">
                                                            <i class="fas fa-times"></i> Yakında
                                                        </div>
                                                    <?php
                                                        }
                                                    ?>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="<?=base_url("pvpservers/edit/" . $item->id)?>" class="btn btn-primary btn-sm">
                                                                <i class="fas fa-edit"></i> Düzenle
                                                            </a>
                                                            <a href="<?=base_url("pvpservers/edit/" . $item->id . "?delete")?>" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal<?=$item->id?>">
                                                                ...
                                                                <div class="modal-dialog modal-sm" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="<?=base_url("pvpservers/edit/" . $item->id . "?delete")?>" class="btn btn-danger">Sil</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    ?>
                                    <div class="alert alert-info mb-0">Hiç kayıtlı server bulunmuyor.</div>
                                    <?php
                                        }
                                    ?>
                                    </div>
