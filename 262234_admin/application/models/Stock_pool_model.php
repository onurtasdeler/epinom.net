...
class Stock_pool_model extends CI_Model
{

    public $tableName = "stock_pool";
    ...
    function updateStock($arr = array(), $whereArray = array()){
        return $this->db->where($whereArray)->update($this->tableName, $arr);
    }

    function insertStock($arr = array()){
        return $this->db->insert($this->tableName, $arr);
    }

    function deleteStock($arr = array()){
