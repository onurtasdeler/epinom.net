...
class Saldiri extends CI_Controller
{
    public $formControl     = "";
    public $imgId           = "";
    public $settings        = "";
    public $viewFolder      = "saldiri/saldiri";
    public $viewFile        = "blank";
    public $tables          = "table_girisler";
    public $baseLink        = "saldirilar";
    ...
    public function index($id="")
    {
        ...
        $page = array(
            "pageTitle" => "Saldırılar - " . $this->settings->firma_unvan,
            "subHeader" => "Saldırılar",
            "h3" => "Saldırılar",
    ...
    public function list_table($id=""){
        ...
        $sql = "select s.id as ssid,s.ip,s.domain,s.agent,s.saldiri,s.created_at from ".$this->tables." as s ".$join;
        $where = [];
        $order = ['name', 'asc'];
