...
class Logs extends CI_Controller
{
    ...
    public function list_table_kullanici($id = "")
    {
        ...
        $sql = "select s.id as ssid,s.status,s.ip,u.full_name,s.user_id,s.description,u.nick_name,s.title,s.date from " . $this->tables . " as s left join table_users as u on s.user_id=u.id";
        $where = [];
