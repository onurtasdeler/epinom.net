...
<head>
    <meta charset="utf-8" />
    <title>Error Page - 1 | Keenthemes</title>
    ...
    <link href="<?= base_url() ?><?= base_url() ?>assets/backend/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="<?= base_url() ?>assets/backend/media/logos/favicon.ico" />
</head>
<!--end::Head-->
<!--begin::Body-->
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url(<?= base_url() ?>assets/backend/media/error/bg1.jpg);">
        <!--begin::Content-->
        <h1 class="font-weight-boldest text-dark-75 mt-15" style="font-size: 10rem">404</h1>
        <p class="font-size-h3 text-muted font-weight-normal">Bu sayfaya erişim izniniz yoktur.</p>
        <!--end::Content-->
    </div>
    <!--end::Error-->
</div>
