...
function getEmailTemplate($section, $stateArray = array()){
    $templatesFolder = base_url('email_templates');
    switch($section){
        case "order":
        ...
        case "orderGift":
            ...
            $file = str_replace('{{@sender}}', getUser($codes[0]->user_id)->email, $file);
            return $file;
        break;
        case "helpdesk":
        ...
        case "forgot_password":
            $file = file_get_contents($templatesFolder . '/forgot_password/forgot_password.html');
            $file = str_replace('{{@renew_password_url}}', $stateArray['renew_password_url'], $file);
            return $file;
        break;
    }
}