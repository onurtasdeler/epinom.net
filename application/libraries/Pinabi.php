...
class Pinabi
{
    ...
    function newEpinOrder($order_id,$quantity,$prod_id,$playerInfo) {
        return json_decode($this->getResult('setOrder',"POST",[
            "transactionId"=> $order_id,
            "quantity"=>$quantity,
            "productId"=>$prod_id,
            "clientPlayerInfo"=>!empty($playerInfo)?$playerInfo:null,
            "clientPlayerNickname"=>null
        ]));
    }
