                        ...
                        <div class="row">
                            <div class="col-lg-3 col-12">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body p-0">        
                                        ...
                                        <a href="<?=base_url("uye/hesabim/sifre")?>" class="list-group-item list-group-item-action active border-left-0 border-right-0">
                                            Şifre Yenileme
                                        </a>
                            ...
                            <div class="col-lg-9 col-12 mt-4 mt-md-0">
                                <div class="card shadow-sm">
                                    ...
                                    ?>
                                    <?=form_open('uye/hesabim/sifre')?>
                                        <div class="form-group">
                                            <label class="form-label">Mevcut Şifre</label>
                                            <input type="password" placeholder="Mevcut Şifre" class="form-control" name="currentPassword" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Yeni Şifre</label>
                                            <input type="password" placeholder="Yeni Şifre" class="form-control" style="border-bottom:0;border-bottom-left-radius:0;border-bottom-right-radius:0;" name="newPassword" required>
                                            <input type="password" placeholder="Yeni Şifre Tekrar" class="form-control" style="border-top-left-radius:0;border-top-right-radius:0;" name="newPasswordRe" required>
                                            <p class="help-block text-muted small">Yeni şifreniz minimum 6 karakter, maksimum 12 karakterden oluşmalıdır.</p>
                                        </div>
                                        <div class="text-end">
                                            <button type="submit" name="submitRenewPassword" value="ok" class="btn btn-sm btn-primary">
                                                Şifreyi Güncelle
                                            </button>
                                        </div>
                                    <?=form_close()?>
