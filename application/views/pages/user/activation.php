...
<head>
    ...
    ?>
    <title><?=getSiteTitle()?> - Üyelik Aktivasyonu</title>
</head>
                ...
                <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						...
						<div class="page-title d-flex flex-column me-3">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Üyelik Aktivasyonu</h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
								...
								<!--end::Item-->
								<li class="breadcrumb-item text-gray-500">Üyelik Aktivasyonu</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
					...
					<div class="content flex-row-fluid" id="kt_content">
                        <div class="row g-5">
                            <div class="col-12 col-md-4 mx-auto">
                                <div class="alert alert-info">Lütfen e-posta adresi veya telefon numaranıza gönderilen aktivasyon kodunu giriniz.</div>
                                <div class="card shadow-sm mt-3">
                                    <div class="card-body">
                                    <?php
                                        echo form_open(current_url(), [
                                            "id" => "activationPageForm",
                                            "class" => "activationPageForm"
                                        ]);
                                    ?>
                                    ...
                                    <?php
                                        if(isset($alert)):
                                    ?>
                                            <div class="alert alert-<?=$alert["class"]?> mb-3"><?=$alert["message"]?></div>
                                    <?php
                                        endif;
                                    ?>

                                        <div class="form-group">
                                            <input type="text" required class="form-control-lg form-control" name="code" placeholder="Aktivasyon Kodu" maxlength="6" value="<?=set_value('code'); ?>">
                                        </div>
                                        <div class="d-flex justify-content-between mt-3">
                                            <button type="submit" name="activation" value="<?=md5(rand())?>" class="btn btn-sm btn-primary text-uppercase font-weight-bold">
                                                <span>Onayla</span>
                                            </button>
                                        </div>
                                ...
                                <div class="d-flex mt-3">
                                    <a href="<?=base_url('sayfa/bize-ulasin')?>" class="btn btn-dark btn-sm mx-auto">
