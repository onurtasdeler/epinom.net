                            ...
                            <div class="col-lg-3 col-12">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body p-0">        
                                        ...
                                        <a href="<?=base_url("uye/cekim-bildirimlerim")?>" class="list-group-item list-group-item-action active border-left-0 border-right-0">
                                            Nakit Çek
                                        </a>
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-toolbar gap-3">
                                            ...
                                            <a href="<?=base_url('uye/cekim-bildirimlerim/olustur')?>" class="btn btn-primary btn-sm">Çekim Bildirimi Oluştur</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            <?php
                                            if(count($balance_withdraw_requests)>0){
                                                ?>
                                            <div class="table-responsive">
                                                <table class="table table-striped gy-7 gs-7">
                                                    <thead>
                                                        <tr>
                                                            <th class="fw-bold text-nowrap" scope="col">Durum</th>
                                                            <th class="fw-bold text-nowrap" scope="col">Tutar</th>
                                                            <th class="fw-bold text-nowrap" scope="col">Banka Hesabı</th>
                                                            <th class="fw-bold text-nowrap" scope="col">Tarih</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php
                                                    foreach($balance_withdraw_requests as $_n):
                                                        $informationJSON = json_decode($_n->information_json);
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-nowrap"><?=number_format($_n->amount, 2, ',', '.')?> AZN</td>
                                                            <td class="small text-nowrap align-middle"><?='<strong>' . $informationJSON->bank_account->account_name . '</strong> - ' . $informationJSON->bank_account->full_name?></td>
                                                            <td class="text-nowrap">
                                                ...
                                                ?>
                                                <div class="text-center text-muted pb-3 pt-1">Hiç kayıt bulunmuyor.</div>
                                                <?php
                                            }
                                            ?>
                                    </div>
