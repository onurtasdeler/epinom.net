...
<head>
    ...
    ?>
    <title><?=getSiteTitle()?> - Bildirimlerim</title>
</head>
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body p-0">        
                                        ...
                                        <a href="<?=base_url("uye/bildirimlerim")?>" class="list-group-item list-group-item-action active border-left-0 border-right-0">
                                            Bildirimlerim
                                        </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped gy-7 gs-7">
                                                <thead>
                                                    <tr>
                                                        <th class="text-nowrap fw-bold" scope="col">Başlık</th>
                                                        <th class="text-nowrap fw-bold" scope="col">İçerik</th>
                                                ...
                                                foreach($notifications as $_n):
                                                    ?>
                                                    <tr style="<?= !empty($_n->link)?"cursor:pointer;":"" ?>" onclick="<?= !empty($_n->link)?"location.href='{$_n->link}'":"" ?>">
                                        ...
                                        ?>
                                            <div class="text-center text-muted pb-3 pt-1">Hiç bildirim bulunmuyor.</div>
                                        <?php
                                            }
                                        ?>
                                    </div>
