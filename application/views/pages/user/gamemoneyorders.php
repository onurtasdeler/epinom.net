        ...
        <div class="col-lg-9 col-12 mt-4 mt-md-0">
            <div class="bg-white shadow-sm">
                <div class="d-flex justify-content-between align-items-center text-black bg-light border-bottom border-primary pb-3 pt-3 pl-3">
                    ...
                    <div class="pr-2">
                        <div class="btn-group">
                            ...
                            <a href="<?=base_url('uye/oyun-parasi-siparislerim')?>" class="btn btn-light btn-sm active">Oyun Parası</a>
                            <a href="<?=base_url('uye/satislarim')?>" class="btn btn-light btn-sm">Bize Sat</a>
                        </div>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <table class="table table-striped table-condensed table-borderless table-light">
                        <thead>
                            <tr>
                        ...
                        foreach($orders as $order):
                            ...
                            <tr style="cursor:pointer;" data-target="#orderModal<?=$order->id?>" data-toggle="modal">
                                <td><?=orderStatusGameMoneys($order->status, "badge")?></td>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-0">
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <em>Karakter Adı: <?=json_decode($order->json)->character_name?></em>
                                                    </td>
                                                    <td><?=$order->qty?> <small>Adet</small></td>
                                        ...
                                        <div class="text-right text-light pt-2 pb-2 pr-2">
                                    ...
                                    <div class="modal-footer border-top-0 justify-content-between">
                                        <div>Sipariş Durumu: <?=orderStatusGameMoneys($order->status, 'badge')?></div>
