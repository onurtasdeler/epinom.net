                                ...
                                <div class="card shadow-sm">
                                    <div class="card-header">
                                        ...
                                        <div class="card-toolbar gap-3">
                                            <a href="<?=base_url('uye/banka-hesaplarim/olustur')?>" class="btn btn-primary btn-sm">Banka Hesabı Oluştur</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            <?php
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped gy-7 gs-7">
                                                    <thead>
                                                    <tr>
                                                        <th class="text-nowrap fw-bold" scope="col">Banka Adı</th>
                                                        <th class="text-nowrap fw-bold" scope="col">Hesap Sahibi</th>
                                                        <th class="text-nowrap fw-bold" scope="col">IBAN Numarası</th>
                                                        <th class="text-nowrap fw-bold" scope="col">İşlemler</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php
                                                        foreach($user_bank_accounts as $_n):
                                                    ?>
                                                        <tr>
                                                            <td class="align-middle text-nowrap font-weight-bold"><?=$_n->account_name?></td>
                                                            <td class="align-middle text-nowrap"><?=$_n->full_name?></td>
                                                            <td class="small text-nowrap align-middle"><?=$_n->iban?></td>
                                                            <td class="text-nowrap">
                                                                <a href="<?=base_url('uye/banka-hesaplarim?d=1&i=' . $_n->id . '&a=' . md5($_n->id))?>" onclick="return confirm('Silmek istediğinize emin misiniz?')" data-toggle="tooltip" title="Sil" class="btn btn-danger btn-sm btn-block">
                                                                    <i data-feather="trash-2" width="15" height="15"></i> <span>Sil</span>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                ...
                                                ?>
                                                <div class="text-center text-muted pb-3 pt-1">Hiç banka hesabı bulunmuyor.</div>
                                                <?php
                                            }
                                            ?>
                                    </div>
