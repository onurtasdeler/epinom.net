                ...
                <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						...
						<div class="page-title d-flex flex-column me-3">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Şifremi Sıfırla</h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
								...
								<!--end::Item-->
								<li class="breadcrumb-item text-gray-500">Şifremi Sıfırla</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
                                ...
                                <div class="loginPageArea p-5 card-rounded shadow-sm" id="activationArea" style="display:none;">
                                    ...
                                    if(@$alert['class'] != 'success'){
                                        ...
                                        <div class="form-group">
                                            <input type="password" required class="form-control" name="newPassword" placeholder="Yeni Şifre">
                                            <?php
                                            if(isset($form_error)):
                                                ?>
                                                <div class="small text-danger"><?=form_error('newPassword')?></div>
                                            <?php
                                            endif;
                                            ?>
                                        </div>
                                        <div class="form-group mt-3">
                                            <input type="password" required class="form-control" name="newPasswordRe" placeholder="Yeni Şifre Tekrar">
                                            <?php
                                            if(isset($form_error)):
                                                ?>
                                                <div class="small text-danger"><?=form_error('newPasswordRe')?></div>
                                            <?php
                                            endif;
                                            ?>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 text-end">
                                                <button type="submit" name="forgot_password_step_2" value="<?=md5(rand())?>" class="btn btn-sm btn-primary text-uppercase font-weight-bold">
