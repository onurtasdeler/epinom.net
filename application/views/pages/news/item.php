                ...
                <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						...
						<div class="page-title d-flex flex-column me-3">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder my-1 fs-3"><?= $item->title ?></h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                                ...
                                <li class="breadcrumb-item text-gray-500" aria-current="page"><?=$item->title?></li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title-->
									...
									<div class="flex-lg-row-fluid me-xl-15">
										...
										<div class="mb-17">
											...
											<div class="mb-8">
												...
												<!--end::Info-->
												<!--begin::Title-->
												<a href="#" class="text-dark text-hover-primary fs-2 fw-bolder"><?= $item->title ?></a>
												<!--end::Title-->
												<!--begin::Container-->
												<div class="mt-8">
													<!--begin::Image-->
													<div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px" style="background-image:url(<?=base_url("public/news/" . $item->image_url)?>)"></div>
													<!--end::Image-->
												</div>
												<!--end::Container-->
											</div>
