        ...
        <div class="col-lg-9">
            ...
            <div class="bg-white p-2 shadow-sm border-primary border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Bize Sat</h4>
                    <a href="<?=base_url('oyun-parasi-urunu/' . $product->slug . '/' . $product->id)?>" class="btn btn-outline-primary btn-sm">
                        <span data-feather="shopping-cart" width="16" height="16"></span> Satın Al
                    </a>
                </div>
            </div>
                ...
                <div class="row" id="formElements">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <h4><?=$product->title?></h4>
                            <small class="text-primary"><?=$product->information?></small>
                        </div>
                        <div class="form-group">
...
<script async>
    ...
    $(function(){
        $('.bizeSatFormSubmitButton').on('click', function(e){
            ...
            var form = $('#bizeSatForm');
            $.post(form.action, form.serialize(), (res)=>{
                var res = JSON.parse(res);
                if(res.error == false){
                    $('#formElements').remove();
                    setTimeout(function(){
                        window.location.href = "<?=base_url('uye/satislarim')?>";
                    },3000);
                }
