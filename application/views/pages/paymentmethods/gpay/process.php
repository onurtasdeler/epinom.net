                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            if(isset($gpay_response)) {
                                                if ($gpay_response != FALSE) {
                                        ?>
                                                <iframe id="gpay-iframe" src="<?=$gpay_response?>" width="100%" style="height: 1000px; margin: 0 auto;" height="1000" allowfullscreen frameborder="0"></iframe>
                                        <?php
                                                } else {
                                        ?>
