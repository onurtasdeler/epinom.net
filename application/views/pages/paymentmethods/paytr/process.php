                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-9 order-2" id="pay">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            if ($this->uri->segment(2) == 'paytr' && $this->uri->segment(3) == 'ininal') {
                                        ?>
                                            <div class="alert alert-warning">
                                                <h3>İninal Kart ile Ödeme Bilgilendirmesi</h3>
                                                <hr>
                                                <p>İninal kartınız ile PAYTR aracılığı ile ödeme yapmak için aşağıdaki ekrandan <strong>"Diğer Ödeme Yöntemleri"</strong> seçeneğine tıklayın. Açılan alandan <strong>"Ön Ödemeli Kartlar"</strong> seçeneğini kullanabilirsiniz.</p>
                                            </div>
                                        <?php
                                            }
                                        ?>
                                        <?php
                                        if (!isset($paytr_response)) {
                                            ?>
